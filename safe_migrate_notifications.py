#!/usr/bin/env python3
"""
Safe migration script for NotificationsPopover.tsx
"""

import re

def safe_migrate_notifications_popover():
    """Safely migrate NotificationsPopover.tsx from layers.* to MD3 tokens"""
    ...
    # Make a backup
    with open('src/components/NotificationsPopover.tsx.backup', 'w', encoding='utf-8') as f:
        f.write(content)
...
if __name__ == '__main__':
    safe_migrate_notifications_popover()