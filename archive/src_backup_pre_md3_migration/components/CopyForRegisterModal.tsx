...
const CopyForRegisterModal: React.FC<CopyForRegisterModalProps> = ({ lesson, entry, students, todaysEvaluations, onClose }) => {
  const { layers } = useTheme();
    ...
    return (
        ...
        >
            <M3DialogContent >
                <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)], borderRadius: ref.shape[] }}>
                    <TabGroup 
                ...
                <div >
                    <div style={{ padding: ref.spacing[12], backgroundColor: sys.colors.[var(--md-sys-color-surface-container)], borderRadius: ref.shape[] }} style={{display: "flex", flexWrap: "wrap", border: "1px solid layers.sys.colors.outline"}}>
