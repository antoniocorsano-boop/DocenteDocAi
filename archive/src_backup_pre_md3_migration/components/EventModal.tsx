        ...
        >
            <M3DialogContent style={{marginTop: layers.ref.spacing['8']}}>
                <form id="event-modal-form" onSubmit={handleSubmit} style={{marginTop: layers.ref.spacing['8']}}>
                    <div>
                        <label style={{ color: sys.colors.[11px] }} style={{color: "layers.sys.colors.primary", fontWeight: "900", textTransform: "uppercase", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4'], marginBottom: layers.ref.spacing['8'], display: "block"}}>Tipo Evento</label>
