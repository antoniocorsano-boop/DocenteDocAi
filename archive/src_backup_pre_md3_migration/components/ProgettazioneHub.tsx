    ...
    return (
        <div  style={{marginLeft: "auto", marginRight: "auto", width: "100%", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>
            ...
            <div  style={{ textAlign: "center" }}>
                <h1 style={{ color: sys.colors.4xl }} style={{fontWeight: "900", color: "layers.sys.colors.primary", marginBottom: layers.ref.spacing['8']}}>Progettazione</h1>
                <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ marginLeft: "auto", marginRight: "auto", fontWeight: "500" }}>
