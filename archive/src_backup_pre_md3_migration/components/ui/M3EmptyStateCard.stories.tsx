      ...
      <div>
        <div style={{ marginBottom: "var(--md-sys-spacing-4)" }}>
          <svg
            ...
            style={{ color: sys.colors.[var(--md-sys-color-outline)] }}
          >
            <path
        ...
        <button style={{ backgroundColor: sys.colors.[var(--md-sys-color-primary)], color: sys.colors.[var(--md-sys-color-on-primary)] }} style={{ paddingLeft: "var(--md-sys-spacing-4)", paddingRight: "var(--md-sys-spacing-4)", borderRadius: ref.spacing[9999] }}>
          Create Document
        </button>
      </div>
    ),
