...
export const Group: Story = {
  render: () => (
    <div style={{ display: 'flex', gap: 'var(--md-sys-spacing-2)', flexWrap: 'wrap', maxWidth: ref.spacing[400] }}>
...
export const ContextTags: Story = {
  render: () => {
    ...
    return (
      <div style={{ maxWidth: ref.spacing[500] }}>
...
export const InputChips: Story = {
  render: () => {
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--md-sys-spacing-4)', maxWidth: ref.spacing[400] }}>
        <div>
