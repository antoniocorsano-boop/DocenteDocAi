    ...
    children: (
      <div>
        ...
        <div style={{ display: "flex", gap: "var(--md-sys-spacing-2)" }}>
          <button style={{ backgroundColor: sys.colors.[var(--md-sys-color-primary)], color: sys.colors.[var(--md-sys-color-on-primary)] }} style={{ paddingLeft: "var(--md-sys-spacing-4)", paddingRight: "var(--md-sys-spacing-4)", borderRadius: ref.spacing[9999], fontSize: "0.875rem" }}>
            Apply
          </button>
          <button style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ paddingLeft: "var(--md-sys-spacing-4)", paddingRight: "var(--md-sys-spacing-4)", border: "1px solid var(--md-sys-color-outline)", borderRadius: ref.spacing[9999], fontSize: "0.875rem" }}>
            Dismiss
          </button>
        </div>
      </div>
      ...
      <div style={{ textAlign: "center", paddingTop: "var(--md-sys-spacing-4)", paddingBottom: "var(--md-sys-spacing-4)" }}>
        <div style={{ marginBottom: "var(--md-sys-spacing-3)" }}>
          <svg
            ...
            style={{ color: sys.colors.[var(--md-sys-color-outline)] }} style={{ marginLeft: "auto", marginRight: "auto" }}
          >
            <path
  ...
  args: {
    ...
    children: (
      <div>
        ...
        <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-high)] }} style={{ padding: "var(--md-sys-spacing-3)", borderRadius: "0.5rem", marginBottom: "var(--md-sys-spacing-3)" }}>
          <code style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontSize: "0.875rem" }}>
            {`// Instead of:
if (condition) {
  // do something
}
