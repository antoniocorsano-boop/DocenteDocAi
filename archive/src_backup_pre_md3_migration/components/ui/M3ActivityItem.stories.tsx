  ...
  args: {
    children: (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-4)" }}>
        <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-primary)] }} style={{ width: "2.5rem", height: "2.5rem", borderRadius: ref.spacing[9999], display: "flex", alignItems: "center", justifyContent: "center" }}>
          <span style={{ color: sys.colors.[var(--md-sys-color-on-primary)] }} style={{ fontWeight: "500" }}>A</span>
        </div>
        <div style={{ flex: "1" }}>
          <M3Typography variant="body-large" as="p" >
            Activity completed
          </M3Typography>
          <M3Typography variant="body-small" as="p" style={{ color: sys.colors.[var(--md-sys-color-outline)] }}>
            2 hours ago
          </M3Typography>
        </div>
        <div style={{ color: sys.colors.[var(--md-sys-color-outline)] }}>
...
export const DocumentActivity: Story = {
  args: {
    children: (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-4)" }}>
        <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-secondary)] }} style={{ width: "2.5rem", height: "2.5rem", borderRadius: ref.spacing[9999], display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <M3Typography variant="label-small" as="span" style={{ color: sys.colors.[var(--md-sys-color-primary)] }}>
          New
        </M3Typography>
      </div>
    ),
    ...
    children: (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-4)" }}>
        <img
          ...
          alt="User avatar"
          style={{ width: "2.5rem", height: "2.5rem", borderRadius: ref.spacing[9999] }}
        />
        <div style={{ flex: "1" }}>
          <M3Typography variant="body-large" as="p" >
        ...
        <div style={{ display: "flex", gap: "var(--md-sys-spacing-2)" }}>
          <button style={{ color: sys.colors.[var(--md-sys-color-primary)] }} style={{ border: "1px solid var(--md-sys-color-outline)", borderRadius: ref.spacing[9999], fontSize: "0.875rem" }}>
            View Profile
          </button>
        </div>
      </div>
