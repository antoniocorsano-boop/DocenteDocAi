    ...
    children: (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-3)" }}>
          <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-primary)] }} style={{ width: ref.spacing[32], height: ref.spacing[32], borderRadius: ref.spacing[9999], display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <button style={{ color: sys.colors.[var(--md-sys-color-primary)] }} style={{ border: "1px solid var(--md-sys-color-outline)", borderRadius: ref.spacing[9999], fontSize: "0.875rem", transition: "color 300ms" }}>
          Apply
        </button>
      </div>
    ),
        ...
        {suggestions.map((suggestion, index) => (
          ...
          >
            <div style={{ display: "flex", alignItems: "flex-start", gap: "var(--md-sys-spacing-3)" }}>
              <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-secondary)] }} style={{ width: "1.5rem", height: "1.5rem", borderRadius: ref.spacing[9999], display: "flex", alignItems: "center", justifyContent: "center", flexShrink: "0" }}>
                <span style={{ color: sys.colors.[var(--md-sys-color-on-secondary)] }} style={{ fontSize: "0.75rem", fontWeight: "500" }}>
                  {index + 1}
                </span>
              </div>
              <M3Typography variant="body-medium" as="p">
...
export const ReadOnly: Story = {
  args: {
    children: (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-3)" }}>
        <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-outline)] }} style={{ width: ref.spacing[32], height: ref.spacing[32], borderRadius: ref.spacing[9999], display: "flex", alignItems: "center", justifyContent: "center" }}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="var(--md-sys-color-surface)">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
          </svg>
        </div>
        <M3Typography variant="body-medium" as="p" style={{ color: sys.colors.[var(--md-sys-color-outline)] }}>
