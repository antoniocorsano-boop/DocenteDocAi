...
const Home: React.FC<HomeProps> = ({ onNavigate, dismissSuggestion }) => {
  const { layers } = useTheme();
    ...
    try {
    return (
        <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface)] }} style={{ display: "flex", flexDirection: "column", minHeight: "100vh", overflowX: "hidden", overflowY: "auto" }}>
            ...
            {/*
            <section>
                <M3Typography variant="label-small" style={{ color: sys.colors.on-surface-variant }} style={{ textTransform: "uppercase", letterSpacing: "0.1em", fontWeight: "900", opacity: "0.5" }}>
                    Azioni rapide
                </M3Typography>
            ...
            <section>
                <div >
                    <M3Card  onClick={() => onNavigate('studenti' as View)}>
                        <span >groups</span>
                        <div style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }}>Studenti</div>
                        <div style={{ color: sys.colors.[var(--md-sys-color-on-surface-variant)] }}>{metrics.studenti} iscritti</div>
                    </M3Card>
                    <M3Card  onClick={() => onNavigate('evaluations' as View)}>
                        <span >assignment</span>
                        <div style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }}>Verifiche oggi</div>
                        <div style={{ color: sys.colors.[var(--md-sys-color-on-surface-variant)] }}>{metrics.verificheOggi} programmate</div>
                    </M3Card>
                    <M3Card  onClick={() => onNavigate('studenti' as View)}>
                        <span >check_circle</span>
                        <div style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }}>Presenze</div>
                        <div style={{ color: sys.colors.[var(--md-sys-color-on-surface-variant)] }}>{metrics.presenze} media</div>
                    </M3Card>
                </div>
            </section>
                                ...
                                <div >
                                    ...
                                    <div>
                                        ...
                                        <button
                                            ...
                                            onMouseEnter={e => { e.currentTarget// removed runtime mutation }}
                                            onMouseLeave={e => { e.currentTarget// removed runtime mutation }}
                                        >
                                            Scopri di più
                                        </button>
                                    </div>
