  ...
  return (
    <nav
      style={{display: 'flex',
        ...
        backgroundColor: 'layers.sys.colors.surface-container-lowest',
      ...
      {mainMenuItems.map(item => {
        ...
        return (
          <button
            ...
            style={{backgroundColor: active ? 'layers.sys.colors.primary-container' : 'layers.sys.colors.surface-container-lowest',
              color: active ? 'layers.sys.colors.on-primary-container' : 'layers.sys.colors.on-surface-variant',
          ...
          >
            <div
              style={{marginBottom: layers.ref.spacing['1'], // 2px spacing
                backgroundColor: active ? 'layers.sys.colors.primary-container' : 'transparent',
