...
export const M3Button: React.FC<M3ButtonProps> = ({ 
  ...
  // Size tokens
  let padding = `${ref.spacing[3]} ${ref.spacing[4]}`;
  let minHeight = ref.spacing[11];
  if (size === 'small') {
    padding = `${ref.spacing[2]} ${ref.spacing[3]}`;
    minHeight = ref.spacing[9];
  } else if (size === 'large') {
    padding = `${ref.spacing[5]} ${ref.spacing[6]}`;
    minHeight = ref.spacing[12];
  }
