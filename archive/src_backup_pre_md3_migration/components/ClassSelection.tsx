  ...
  const { layers } = useTheme();
    ...
    return (
        <div >
            ...
            <div >
                <div >
                    <h1 style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "900" }}>Le Mie Classi</h1>
                    <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }}>Gestione studenti e analisi.</p>
                </div>
            </div>
            ...
            {upcomingTests.length > 0 && (
                <section >
                    <h2 style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ fontSize: "0.875rem", textTransform: "uppercase", letterSpacing: "0.05em" }}>
            ...
            <section>
                ...
                {userClasses.length > 0 ? (
                    ...
                    <div style={{ padding: ref.spacing[12], backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)], borderRadius: ref.shape[] }} style={{textAlign: "center", border: "1px solid layers.sys.colors.outline"}}>
                        <span style={{ color: sys.colors.6xl, color: sys.colors.[var(--md-sys-color-on-surface)]-variant/50 }} style={{marginBottom: layers.ref.spacing['8']}}>domain_disabled</span>
                        <p style={{ color: sys.colors.[var(--md-sys-typescale-headline-small)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }}>Nessuna classe definita</p>
                        <p style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{marginTop: layers.ref.spacing['4'], marginBottom: layers.ref.spacing['6']}}>
            ...
            <section>
                ...
                <div >
                    ...
                    >
                        <span  style={{color: "layers.sys.colors.tertiary"}}>accessibility_new</span>
    ...
    return (
        ...
        >
            <M3DialogContent style={{gap: layers.ref.spacing['6']}}>
                    <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }}>Seleziona le classi e il periodo per cui generare il prospetto voti (PDF).</p>
                    
                    <div style={{gap: layers.ref.spacing['2']}}>
                        <label style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ fontSize: "0.875rem", fontWeight: "500" }}>Periodo</label>
                        <TabGroup
                            tabs={[
                    ...
                    <div style={{gap: layers.ref.spacing['2']}}>
                        <label style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ fontSize: "0.875rem", fontWeight: "500" }}>Classi</label>
