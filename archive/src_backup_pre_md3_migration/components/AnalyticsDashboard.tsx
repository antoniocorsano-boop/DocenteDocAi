  ...
  return (
    ...
    >
      <M3DialogContent style={{display: 'flex',
        ...
        maxHeight: '80vh'}}>
          {/* GDPR Notice */}
          <div style={{backgroundColor: 'layers.sys.colors.tertiary-container',
            opacity: 0.8,
            ...
            <div style={{display: 'flex',
              ...
              <span style={{fontFamily: 'Material Symbols Outlined',
                color: 'layers.sys.colors.on-tertiary-container',
                marginTop: ref.spacing[2]}}>privacy_tip</span>
              <div>
                <M3Typography
                  variant="label-small"
                  style={{color: 'layers.sys.colors.on-tertiary-container',
                    fontWeight: '900',
          ...
          {activeTab === 'overview' && (
            <div style={{display: 'flex',
              ...
              <div style={{display: 'grid',
                ...
                gap: layers.ref.spacing['6']}}>
                <div style={{backgroundColor: 'layers.sys.colors.surface-container-low',
                  opacity: 0.5,
          ...
          {activeTab === 'details' && (
            <div style={{display: 'flex',
              ...
              <div style={{maxHeight: ref.spacing[384],
                overflowY: 'auto',
                display: 'flex',
                flexDirection: 'column',
                gap: layers.ref.spacing['2'],
                ...
                scrollbarWidth: 'thin',
                scrollbarColor: 'layers.sys.colors.outline transparent'}}>
                ...
                <div style={{display: 'flex',
                  ...
                  onMouseLeave={() => setHoveredElements(prev => ({ ...prev, 'analytics-toggle': false }))}>
                    ...
                    <div style={{
                      ...
                      />
                      <div style={{width: ref.spacing[44],
                        height: layers.ref.spacing['6'],
                        backgroundColor: analyticsSettings.enabled ? 'layers.sys.colors.primary' : 'layers.sys.colors.outline',
                        borderRadius: layers.ref.spacing['3'],
                        position: 'relative',
                        transition: 'background-color 0.2s ease'}}>
                        <div style={{position: 'absolute',
                          top: ref.spacing[2],
                          left: analyticsSettings.enabled ? ref.spacing[22] : ref.spacing[2],
                          width: ref.spacing[20],
                          height: ref.spacing[20],
                          backgroundColor: 'layers.sys.colors.on-primary',
                          borderRadius: '50%',
                  ...
                  <label>
                    ...
                    <div style={{position: 'relative', display: 'inline-flex', alignItems: 'center', cursor: 'pointer'}}>
                      ...
                      />
                      <div style={{width: ref.spacing[44], height: ref.spacing[24], backgroundColor: analyticsSettings.enabled ? primary : outline, borderRadius: ref.spacing[9999], position: 'relative', transition: 'background-color 0.2s ease'}}>
                        <div style={{position: 'absolute', top: ref.spacing[2], left: analyticsSettings.enabled ? ref.spacing[22] : ref.spacing[2], width: ref.spacing[20], height: ref.spacing[20], backgroundColor: 'white', borderRadius: '50%', transition: 'left 0.2s ease'}}></div>
                      </div>
                    </div>
                  </label>
                    ...
                    <>
                      ...
                      onMouseLeave={() => setHoveredElements(prev => ({ ...prev, 'feature-usage-toggle': false }))}>
                        ...
                        <div style={{
                          ...
                          <div style={{width: ref.spacing[44],
                            height: layers.ref.spacing['6'],
                            backgroundColor: analyticsSettings.collectFeatureUsage ? 'layers.sys.colors.primary' : 'layers.sys.colors.outline',
                            borderRadius: layers.ref.spacing['3'],
                            position: 'relative',
                            transition: 'background-color 0.2s ease'}}>
                            <div style={{position: 'absolute',
                              top: ref.spacing[2],
                              left: analyticsSettings.collectFeatureUsage ? ref.spacing[22] : ref.spacing[2],
                              width: ref.spacing[20],
                              height: ref.spacing[20],
                              backgroundColor: 'layers.sys.colors.on-primary',
                              borderRadius: '50%',
                      ...
                      onMouseLeave={() => setHoveredElements(prev => ({ ...prev, 'document-metrics-toggle': false }))}>
                        ...
                        <div style={{
                          ...
                          <div style={{width: ref.spacing[44],
                            height: layers.ref.spacing['6'],
                            backgroundColor: analyticsSettings.collectDocumentMetrics ? 'layers.sys.colors.primary' : 'layers.sys.colors.outline',
                            borderRadius: layers.ref.spacing['3'],
                            position: 'relative',
                            transition: 'background-color 0.2s ease'}}>
                            <div style={{position: 'absolute',
                              top: ref.spacing[2],
                              left: analyticsSettings.collectDocumentMetrics ? ref.spacing[22] : ref.spacing[2],
                              width: ref.spacing[20],
                              height: ref.spacing[20],
                              backgroundColor: 'layers.sys.colors.on-primary',
                              borderRadius: '50%',
              ...
              <div style={{backgroundColor: 'layers.sys.colors.surface-container-low',
                ...
                <div style={{display: 'flex',
                  ...
                  <div style={{display: 'flex',
                    ...
                    borderTop: '1px solid layers.sys.colors.outline',
                    opacity: 0.1}}>
                    <div>
                      <M3Typography
                        variant="label-small"
