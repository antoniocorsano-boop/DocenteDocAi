        ...
        <div >
            ...
            <div >
                <h2  style={{marginBottom: layers.ref.spacing['8'], display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
                    <span  style={{color: "layers.sys.colors.primary"}}>folder_open</span>
                ...
                <div style={{display: "flex", flexWrap: "wrap", gap: layers.ref.spacing['8'], alignItems: "flex-end", marginBottom: layers.ref.spacing['8']}}>
                    <div  style={{ flexGrow: "1" }}>
                     ...
                     <div  style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
                        <span style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }}>attachment</span>
                        <p style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ fontWeight: "bold" }}>
                    ...
                    {availableFiles.map(entry => (
                        <div key={entry.id} >
                            ...
                            <label htmlFor={`studio-file-${entry.id}`} >
                                ...
                                <span  style={{color: "layers.sys.colors.primary", fontSize: ref.spacing[16]}}>{entry.isGenerated ? 'auto_awesome' : 'description'}</span>
                                <span style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{entry.fileName}</span>
                            </label>
                        </div>
                    ))}
                    {availableFiles.length === 0 && (
                        <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{fontSize: "0.875rem", padding: layers.ref.spacing['8']}}>Nessun file disponibile in questo set.</p>
                    )}
                </div>
            </div>
            ...
            {/* Loading State */}
            {isLoading && (
                <div style={{ padding: ref.spacing[12] }} style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
            ...
            {!isLoading && (
                <div >
                    ...
                    <div  style={{ height: "100%" }}>
                        <div style={{marginBottom: layers.ref.spacing['8']}}>
                            <h2  style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
                                <span  style={{color: "layers.sys.colors.tertiary"}}>design_services</span>
                                Generazione & Creatività
                            </h2>
                            <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{marginTop: layers.ref.spacing['4']}}>Crea nuovi contenuti didattici.</p>
                        </div>
                    ...
                    <div  style={{ height: "100%" }}>
                        <div style={{marginBottom: layers.ref.spacing['8']}}>
                            <h2  style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
                                <span  style={{color: "layers.sys.colors.secondary"}}>analytics</span>
                                Analisi & Sintesi
                            </h2>
                            <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{marginTop: layers.ref.spacing['4']}}>Rielabora e comprendi i documenti.</p>
                        </div>
