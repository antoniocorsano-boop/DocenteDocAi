  ...
  const { layers } = useTheme();
                ...
                <tbody>
                    {students.map(student => {
                        ...
                        return (
                            <tr key={student.id}>
                                <td >
                                    <M3Button variant="text" onClick={() => onViewStudentProfile(student)} style={{ borderRadius: ref.shape[] }} style={{ fontWeight: "500" }} type="button">
                                ...
                                <td className={`min-w-[200px] md:min-w-[300px] ${getCellClassName('giudizio')}`}>
                                    <div >
                                        ...
                                        <M3Button variant="text" onClick={() => handleAiSuggest(student)} disabled={loadingAi === student.id} style={{ borderRadius: ref.shape[] }} title="Suggerisci con AI" type="button">
                                            <span style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)] }}>{loadingAi === student.id ? 'pending' : 'auto_awesome'}</span>
                                        </M3Button>
                                    </div>
                                </td>}
                                {showFinalGrades && expandedColumns.valutazione && <>
                                    ...
                                    <div style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['8'], marginTop: layers.ref.spacing['4']}}>
                                        ...
                                        {performance.trend && (
                                            <span className={`flex items-center gap-4 m3-label-large ${trendClass}`}>
                                                <span style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)] }}>{trendIcon}</span>
                                            </span>
                                        )}
                                    </div>
                                </div>
    ...
    return (
        <div  style={{maxWidth: "100%", marginLeft: "auto", marginRight: "auto", width: "100%", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>
            ...
            {narrativeReport && (
                <InfoCard variant="elevated" style={{ backgroundColor: sys.colors.primary-container/5 }} style={{padding: layers.ref.spacing['8'], marginBottom: layers.ref.spacing['8']}}>
                    <div style={{display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: layers.ref.spacing['6']}}>
                        <div style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['6']}}>
                            <div style={{ backgroundColor: sys.colors.primary/10 }} style={{width: "2.5rem", height: "2.5rem", borderRadius: ref.spacing[9999], display: "flex", alignItems: "center", justifyContent: "center", color: "layers.sys.colors.primary"}}>
                                <span style={{
  fontFamily: 'Material Symbols Outlined'
}}>description</span>
                            </div>
                            <h3 style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "900" }}>Report Narrativo Suggerito</h3>
                        </div>
                        <div style={{display: "flex", gap: layers.ref.spacing['8']}}>
                    ...
                    <div style={{ color: sys.colors.[var(--md-sys-color-on-surface)], backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]est/50, borderRadius: ref.shape[] }} style={{lineHeight: "1.625", whiteSpace: "pre-wrap", padding: layers.ref.spacing['6'], border: "1px solid layers.sys.colors.outline"}}>
                        {narrativeReport}
                    </div>
                </InfoCard>
            )}

            <InfoCard variant="elevated" style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]est }}>
                 <div  style={{padding: layers.ref.spacing['8'], display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: layers.ref.spacing['8'], borderBottom: "1px solid layers.sys.colors.outline"}}>
