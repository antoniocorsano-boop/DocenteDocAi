...
const DonutChart: React.FC<DonutChartProps> = ({ data }) => {
  ...
  return (
    <div style={{ position: 'relative', width: ref.spacing[200], height: ref.spacing[200] }}>
      <svg width="200" height="200" viewBox="0 0 200 200">
        <g transform="rotate(-90 100 100)">
         ...
         <text x="100" y="95" textAnchor="middle"  fill="var(--md-sys-color-on-surface)" fontWeight="bold" fontSize="24">
            {summary.value}
        </text>
        <text x="100" y="115" textAnchor="middle"  fill="var(--md-sys-color-on-surface-variant)" fontSize="12">
            {summary.label}
        </text>
      </svg>
    </div>
