    ...
    return (
        <div style={{position: 'relative',
            ...
            <div style={{position: 'absolute',
                ...
                width: ref.spacing[120],
                height: ref.spacing[120],
                backgroundColor: 'layers.sys.colors.primary-container',
            ...
            <div style={{position: 'absolute',
                ...
                width: ref.spacing[80],
                height: ref.spacing[80],
                backgroundColor: 'layers.sys.colors.secondary-container',
                borderRadius: 'layers.ref.shape.corner.full',
                opacity: 0.08,
                filter: 'blur(30px)',
                zIndex: 0}} />
                    ...
                    <div style={{display: 'flex',
                        ...
                        <div style={{width: ref.spacing[48],
                            ...
                            <span style={{fontFamily: 'Material Symbols Outlined',
                                ...
                                color: 'layers.sys.colors.on-primary-container'}}>calendar_view_week</span>
                        </div>
                        <div style={{ minWidth: 0, flex: 1 }}>
                            <M3Typography variant="headline-small" style={{color: 'layers.sys.colors.on-surface',
                                fontWeight: 900,
                                margin: 0}}>Il Mio Orario</M3Typography>
                            <M3Typography variant="body-small" style={{color: 'layers.sys.colors.on-surface-variant',
                                margin: 0,
                    ...
                    <div style={{display: 'flex',
                        ...
                        {viewMode === 'day' && (
                            <div style={{display: 'flex',
                                ...
                                />
                                <M3Typography variant="label-large" style={{color: 'layers.sys.colors.on-surface',
                                    fontWeight: 600,
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{padding: layers.ref.spacing['3'],
                                backgroundColor: 'layers.sys.colors.surface-container-highest',
                                borderRadius: 'layers.ref.shape.corner.medium',
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center',
                                border: '1px solid layers.sys.colors.outline-variant'}}>
                                <M3Typography variant="label-large" style={{color: 'layers.sys.colors.on-surface-variant',
                                    fontWeight: 600,
                            ...
                            {visibleDays.map((day, idx) => (
                                <div 
                                    ...
                                    style={{padding: layers.ref.spacing['3'],
                                        ...
                                        justifyContent: 'center',
                                        border: '1px solid layers.sys.colors.outline-variant',
                                        borderLeft: idx === 0 ? '1px solid layers.sys.colors.outline-variant' : 'none'}}
                                >
                                        ...
                                        return (
                                            <div 
                                                ...
                                                style={{borderRadius: timeIdx === settings.timeSlots.length - 1 && dayIdx === visibleDays.length - 1 
                                                    ...
                                                    border: '1px solid layers.sys.colors.outline-variant',
                                                    borderTop: 'none',
                                                    borderLeft: dayIdx === 0 ? '1px solid layers.sys.colors.outline-variant' : 'none',
                                                    overflow: 'hidden',
                                                    cursor: 'pointer',
