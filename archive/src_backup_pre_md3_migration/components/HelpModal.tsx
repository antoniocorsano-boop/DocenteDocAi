...
const SetupGuide = () => (
    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
        ...
        <p style={{fontSize: "var(--md-sys-typescale-body-medium-size)", fontFamily: "var(--md-sys-typescale-body-medium-font)", color: layers.sys.colors.on-surface}}>Segui questi passaggi per configurare OrarioDoc AI per il nuovo anno scolastico.</p>

        <div style={{backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large}}>
            <h3 style={{fontSize: "var(--md-sys-typescale-title-medium-size)", fontFamily: "var(--md-sys-typescale-title-medium-font)", color: layers.sys.colors.primary, fontWeight: "bold", marginBottom: layers.ref.spacing['6']}}>1. Impostazioni Generali</h3>
            <p style={{fontSize: "0.875rem", marginBottom: layers.ref.spacing['6']}}>Vai nel menu <strong>Impostazioni</strong> (icona ingranaggio in alto a destra).</p>
            <ul style={{paddingLeft: layers.ref.spacing['5'], display: "flex", flexDirection: "column", gap: layers.ref.spacing['2']}}>
        ...
        <div style={{backgroundColor: "rgba(layers.sys.colors.surface-container-low-rgb, 0.5)", padding: layers.ref.spacing['5'], borderRadius: layers.ref.shape.corner.large, border: "1px solid rgba(layers.sys.colors.outline-variant-rgb, 0.2)"}}>
            <h3 style={{fontSize: "var(--md-sys-typescale-title-medium-size)", fontFamily: "var(--md-sys-typescale-title-medium-font)", color: layers.sys.colors.primary, fontWeight: "bold", marginBottom: layers.ref.spacing['6']}}>2. Configurazione Classi e Materie</h3>
            <p style={{fontSize: "0.875rem", marginBottom: layers.ref.spacing['6']}}>Sempre in Impostazioni:</p>
            <ul style={{paddingLeft: layers.ref.spacing['5'], display: "flex", flexDirection: "column", gap: layers.ref.spacing['2']}}>
        ...
        <div style={{backgroundColor: "rgba(layers.sys.colors.surface-container-low-rgb, 0.5)", padding: layers.ref.spacing['5'], borderRadius: layers.ref.shape.corner.large, border: "1px solid rgba(layers.sys.colors.outline-variant-rgb, 0.2)"}}>
            <h3 style={{fontSize: "var(--md-sys-typescale-title-medium-size)", fontFamily: "var(--md-sys-typescale-title-medium-font)", color: layers.sys.colors.primary, fontWeight: "bold", marginBottom: layers.ref.spacing['6']}}>3. Inserimento Studenti</h3>
            <p style={{fontSize: "0.875rem", marginBottom: layers.ref.spacing['6']}}>Apri il <strong>Centro Operativo (⚡)</strong> e scegli "Importa Studenti".</p>
            <ul style={{paddingLeft: layers.ref.spacing['5'], display: "flex", flexDirection: "column", gap: layers.ref.spacing['2']}}>
        ...
        <div style={{backgroundColor: "rgba(layers.sys.colors.surface-container-low-rgb, 0.5)", padding: layers.ref.spacing['5'], borderRadius: layers.ref.shape.corner.large, border: "1px solid rgba(layers.sys.colors.outline-variant-rgb, 0.2)"}}>
            <h3 style={{fontSize: "var(--md-sys-typescale-title-medium-size)", fontFamily: "var(--md-sys-typescale-title-medium-font)", color: layers.sys.colors.primary, fontWeight: "bold", marginBottom: layers.ref.spacing['6']}}>4. Costruzione Orario</h3>
            <p style={{fontSize: "0.875rem", marginBottom: layers.ref.spacing['6']}}>Apri il <strong>Centro Operativo (⚡)</strong> e scegli "Configura Orario".</p>
            <ul style={{paddingLeft: layers.ref.spacing['5'], display: "flex", flexDirection: "column", gap: layers.ref.spacing['2']}}>
...
const DigitalTeacherManual = () => {
    ...
    return (
        <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
            <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['8'], borderBottom: "1px solid layers.sys.colors.outline-variant", paddingBottom: layers.ref.spacing['6'], justifyContent: "space-between", alignItems: "flex-start"}} >
                <div>
                    ...
                    <p style={{fontSize: "var(--md-sys-typescale-body-medium-size)", fontFamily: "var(--md-sys-typescale-body-medium-font)", color: layers.sys.colors.on-surface}}>Versione 4.1.0 - M3 Expressive Edition</p>
                </div>
            ...
            <InfoCard 
                ...
                icon="info"
                variant="primary"
                style={{ backgroundColor: sys.colors.primary-container/10 }}
            />

            <ManualSection title="1. Normativa, Sicurezza e Privacy" icon="security" colorClass="text-tertiary" defaultOpen>
                <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['4'], backgroundColor: layers.sys.colors.surface-container-low}}>
                     <h4  style={{fontWeight: "900", color: layers.sys.colors.primary, textTransform: "uppercase", letterSpacing: "0.1em"}}>GDPR & Sovranità del Dato</h4>
                     ...
                     <h4  style={{fontWeight: "900", color: layers.sys.colors.primary, textTransform: "uppercase", letterSpacing: "0.1em"}}>Norme Scolastiche</h4>
                     <p style={{ fontSize: "0.875rem", lineHeight: "1.625" }}>Il sistema supporta nativamente:</p>
                     <ul style={{paddingLeft: layers.ref.spacing['5'], display: "flex", flexDirection: "column", gap: layers.ref.spacing['1']}}>
            ...
            <ManualSection title="2. Manuale Operativo" icon="school" colorClass="text-primary">
                <h4  style={{ fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em" }}>Configurazione & Strategia</h4>
                <UseCaseCard 
                ...
                <h4  style={{ fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em" }}>In Aula</h4>
                <UseCaseCard 
                ...
                <h4  style={{ fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em" }}>Valutazione</h4>
                 <UseCaseCard 
            ...
            <ManualSection title="3. Visione Strategica per Stakeholders" icon="campaign" colorClass="text-secondary">
                <div style={{display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: layers.ref.spacing['8']}}>
                    <div style={{backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large}}>
                        <h4 style={{ fontWeight: "900", alignItems: "center", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.1em" }}><span  style={{color: layers.sys.colors.primary}}>admin_panel_settings</span> Per il Dirigente</h4>
                        <p style={{fontSize: "0.875rem", color: layers.sys.colors.on-surface, lineHeight: "1.625"}}>Standardizzazione della documentazione didattica e monitoraggio effettivo delle UDA progettate. Riduzione del contenzioso grazie a valutazioni trasparenti.</p>
                    </div>
                    <div style={{backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large}}>
                        <h4 style={{ fontWeight: "900", alignItems: "center", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.1em" }}><span  style={{color: layers.sys.colors.secondary}}>engineering</span> Per l'Animatore Digitale</h4>
                        <p style={{fontSize: "0.875rem", color: layers.sys.colors.on-surface, lineHeight: "1.625"}}>Ambiente "Sandbox" sicuro per formare i docenti all'uso dell'AI Generativa senza rischi per la privacy. Sviluppo competenze DigCompEdu.</p>
                    </div>
                </div>
            </ManualSection>
...
const VocalAssistantGuideContent = () => (
    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
        <h2 style={{fontFamily: "var(--md-sys-typescale-headline-small-font)", fontWeight: "900", alignItems: "center"}}>
            <span  style={{color: layers.sys.colors.primary}}>mic</span>
            Il tuo Copilota Didattico
        </h2>
        <p style={{fontFamily: "var(--md-sys-typescale-body-medium-font)", color: layers.sys.colors.on-surface, lineHeight: "1.625"}}>
        ...
        <div  style={{display: "grid", gridTemplateColumns: "1fr", gap: layers.ref.spacing['8']}}>
            {vocalAssistantGuideData.sections.map((section, idx) => (
                <div key={idx} style={{backgroundColor: "rgba(layers.sys.colors.surface-container-low-rgb, 0.5)", padding: layers.ref.spacing['5'], borderRadius: layers.ref.shape.corner.large, border: "1px solid rgba(layers.sys.colors.outline-variant-rgb, 0.1)"}}>
                    <h3 style={{fontSize: "var(--md-sys-typescale-title-medium-size)", fontFamily: "var(--md-sys-typescale-title-medium-font)", color: layers.sys.colors.primary, fontWeight: "bold", marginBottom: layers.ref.spacing['8'], display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
                        <span  style={{ fontSize: "0.875rem" }}>record_voice_over</span>
                        {section.title}
                    </h3>
                    <ul style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['3']}}>
                        {section.commands.map((cmd, cIdx) => (
                            <li key={cIdx} style={{fontSize: "0.875rem", color: layers.sys.colors.on-surface, backgroundColor: layers.sys.colors.surface-container-high, borderRadius: layers.ref.shape.corner.medium}}>"{cmd}"</li>
                        ))}
                    </ul>
                </div>
            ))}
        ...
        <InfoCard 
            ...
            icon="search"
            variant="secondary"
            style={{ backgroundColor: sys.colors.secondary-container/10 }}
        />
    </div>
);
...
const UserGuide = () => (
    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
        <h2 style={{fontFamily: "var(--md-sys-typescale-headline-small-font)", fontWeight: "900"}}>Guida Rapida al Flusso di Lavoro</h2>
        <div  style={{display: "grid", gridTemplateColumns: "1fr", gap: layers.ref.spacing['8'], marginTop: layers.ref.spacing['6']}}>
            <div style={{backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large, borderLeft: "4px solid"}}>
                <h3  style={{fontWeight: "900", color: layers.sys.colors.primary, textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "0.75rem"}}>1. Centro Operativo</h3>
            ...
            <div style={{backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large, borderLeft: "4px solid"}}>
                <h3  style={{fontWeight: "900", color: layers.sys.colors.secondary, textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "0.75rem"}}>2. Progettazione Intelligente</h3>
            ...
            <div style={{backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large, borderLeft: "4px solid"}}>
                <h3  style={{fontWeight: "900", color: layers.sys.colors.tertiary, textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "0.75rem"}}>3. In Aula (Continuità)</h3>
            ...
            <div style={{backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large, borderLeft: "4px solid"}}>
                <h3  style={{fontWeight: "900", color: layers.sys.colors.error, textTransform: "uppercase", letterSpacing: "0.1em", fontSize: "0.75rem"}}>4. Analisi & Report</h3>
...
const TechnicalSpecs = () => (
    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
        <h2 style={{color: layers.sys.colors.onSurface, fontFamily: layers.ref.typography.headlineSmall.fontFamily, fontWeight: "900"}}>{specsContentData.title}</h2>
        <div style={{backgroundColor: layers.sys.colors.surfaceContainerLow, borderRadius: layers.ref.shape.corner.extraLarge}}>
            <ul style={{marginTop: layers.ref.spacing['4']}}>
                {specsContentData.specs.map((spec, index) => (
                    <li key={index} style={{ alignItems: "flex-start" }}>
                        <span  style={{color: layers.sys.colors.primary}}>check_circle</span>
...
const NormativaContent: React.FC = () => (
    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
        <h2 style={{fontFamily: "var(--md-sys-typescale-headline-small-font)", fontWeight: "900"}}>Privacy e Cloud</h2>
        <p style={{fontFamily: "var(--md-sys-typescale-body-medium-font)", color: layers.sys.colors.on-surface, lineHeight: "1.625"}}>OrarioDoc AI adotta un approccio <strong>privacy-by-design</strong> innovativo.</p>
        
        <div style={{backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.extra-large}}>
            <h3  style={{fontWeight: "bold", color: layers.sys.colors.primary}}>I Tuoi Dati, Il Tuo Cloud</h3>
            <ul style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['3']}}>
                <li style={{ fontSize: "0.875rem" }}>
                    <span  style={{color: layers.sys.colors.primary, fontSize: "0.875rem", marginTop: "0.125rem"}}>shield</span>
                    Non esiste un server centrale di OrarioDoc che legge i tuoi dati.
                </li>
                <li style={{ fontSize: "0.875rem" }}>
                    <span  style={{color: layers.sys.colors.primary, fontSize: "0.875rem", marginTop: "0.125rem"}}>devices</span>
                    Tutto viene salvato nel tuo dispositivo (IndexedDB).
                </li>
                <li style={{ fontSize: "0.875rem" }}>
                    <span  style={{color: layers.sys.colors.primary, fontSize: "0.875rem", marginTop: "0.125rem"}}>cloud_done</span>
...
const FaqContent = () => (
    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
        <h2 style={{fontFamily: "var(--md-sys-typescale-headline-small-font)", fontWeight: "900"}}>Domande Frequenti (FAQ)</h2>
        <div style={{marginTop: layers.ref.spacing['6'], display: "flex", flexDirection: "column", gap: layers.ref.spacing['3']}}>
            {faqContentData.map((faq, i) => (
                <details key={i}  style={{ transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large, overflow: "hidden" }}>
                    <summary  style={{ cursor: "pointer", listStyle: "none", justifyContent: "space-between", alignItems: "center", fontWeight: "bold" }}>
                        <span dangerouslySetInnerHTML={{ __html: faq.q }}></span>
                        <span  style={{ transition: "transform 300ms" }}>expand_more</span>
                    </summary>
                    <div style={{ paddingTop: "0", fontFamily: "var(--md-sys-typescale-body-medium-font)", opacity: "0.8", lineHeight: "1.625", fontSize: "0.875rem"}} dangerouslySetInnerHTML={{ __html: faq.a }}></div>
                </details>
            ))}
        </div>
    </div>
...
const ImprovementsList: React.FC<{onNavigate: (v: View) => void; onClose: () => void; onGenerate: () => void; isGenerating: boolean;}> = ({onNavigate, onClose, onGenerate, isGenerating}) => {
    const ImprovementCard: React.FC<{ title: string; children: React.ReactNode; actionView?: View; icon?: string }> = ({ title, children, actionView, icon = "new_releases" }) => (
        <div  style={{ transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", backgroundColor: layers.sys.colors.surface-container-low, borderRadius: layers.ref.shape.corner.large}}>
            <div style={{ justifyContent: "space-between", alignItems: "flex-start" }}>
                <div style={{ alignItems: "center", flex: "1", minWidth: "0" }}>
                    <div  style={{ transition: "transform 300ms", width: "2.5rem", height: "2.5rem", borderRadius: layers.ref.shape.corner.medium, color: layers.sys.colors.primary, alignItems: "center", justifyContent: "center", flexShrink: "0"}}>
                        <span style={{
  fontFamily: 'Material Symbols Outlined'
}}>{icon}</span>
                    </div>
                    <h4  style={{ fontWeight: "bold", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{title}</h4>
                </div>
                <span style={{color: layers.sys.colors.primary, fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", flexShrink: "0"}}>v4.1.0</span>
            </div>
            <p style={{fontFamily: "var(--md-sys-typescale-body-medium-font)", opacity: "0.7", lineHeight: "1.625", fontSize: "0.875rem", display: "-webkit-box", WebkitLineClamp: "2", WebkitBoxOrient: "vertical", overflow: "hidden"}}>{children}</p>
            {actionView && actionView !== 'home' && (
                ...
                >
                    <span  style={{ marginRight: "0.5rem", fontSize: "0.875rem" }}>arrow_forward</span>
                    Vai alla funzione
                </M3Button>
            )}
        </div>
    ...
    return (
        <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
            <h2 style={{fontFamily: "var(--md-sys-typescale-headline-small-font)", fontWeight: "900"}}>Novità della versione 4.1.0</h2>
            ...
            <div style={{ borderRadius: ref.shape[4], backgroundColor: sys.colors.primary-container/20, color: sys.colors.on-primary-container }} style={{padding: layers.ref.spacing['8'], border: "1px solid layers.sys.colors.outline"}}>
                <div  style={{ alignItems: "center" }}>
                    <div  style={{width: ref.spacing[80], height: ref.spacing[80], borderRadius: layers.ref.shape.corner.extra-large, alignItems: "center", justifyContent: "center", flexShrink: "0"}}>
                        <span style={{ color: sys.colors.4xl }}>picture_as_pdf</span>
                    </div>
                    <div  style={{ flexGrow: "1", textAlign: "center" }}>
                        <h3  style={{ fontWeight: "900" }}>Manuale Completo PDF</h3>
                        <p style={{fontFamily: "var(--md-sys-typescale-body-medium-font)", opacity: "0.7"}}>
                            Scarica il manuale PDF aggiornato alla versione 4.1.0 con la guida al Centro Operativo e le specifiche tecniche.
                        </p>
                    </div>
                </div>
                 <M3Button onClick={onGenerate} disabled={isGenerating} variant="filled"  style={{ width: "100%", fontWeight: "900", fontSize: "0.875rem", textTransform: "uppercase", letterSpacing: "0.1em" }}>
                    <span  style={{ marginRight: "0.5rem" }}>{isGenerating ? 'pending' : 'download'}</span>
...
const HelpModal: React.FC<HelpModalProps> = ({ onClose, onNavigate, aiSettings, setIsLoadingModalOpen, setLoadingModalMessage }) => {
  ...
  return (
    <M3Dialog
      ...
      hideBackdrop={true}
    >
      <M3DialogContent  style={{backgroundColor: layers.sys.colors.surface-container-high}}>
        <div style={{marginTop: layers.ref.spacing['8']}}>
          <div  style={{borderRadius: layers.ref.shape.corner.extra-large, fontSize: "0.875rem"}}>
            <div style={{ alignItems: "center" }}>
                <span  style={{color: layers.sys.colors.primary}}>campaign</span>
                <b style={{color: layers.sys.colors.primary, textTransform: "uppercase", letterSpacing: "0.1em"}}>Novità Dicembre 2025</b>
            </div>
            <ul style={{paddingLeft: layers.ref.spacing['5'], display: "flex", flexDirection: "column", gap: layers.ref.spacing['2']}}>
              ...
              <li>Consulta la <a href="/docs/MIGRAZIONE_COMPONENTI_M3.md" target="_blank" rel="noopener"  style={{color: layers.sys.colors.primary, fontWeight: "bold"}}>guida M3 aggiornata</a> per dettagli e best practice</li>
            </ul>
          </div>
