  ...
  return (
    ...
    >
      <M3DialogContent>
          ...
          {progress && (
            <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container)], borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['8']}}>
              <div style={{display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: layers.ref.spacing['8']}}>
                ...
                <span style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }}>{progress.current}/{progress.total}</span>
              </div>
              <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-high)] }} style={{width: "100%", borderRadius: ref.spacing[9999], height: "0.5rem", marginBottom: layers.ref.spacing['8']}}>
                <div
                   style={{backgroundColor: "layers.sys.colors.primary", height: "0.5rem", borderRadius: ref.spacing[9999], transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", width: `${(progress.current / progress.total) * 100}%` }}
                ></div>
              </div>
              <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{progress.currentDoc}</p>
            </div>
          )}
          ...
          <div  style={{gap: layers.ref.spacing['4'], overflowY: "auto"}}>
            {Object.entries(groupedDocuments).map(([groupName, docs]) => (
              <div key={groupName}>
                <h3 style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: layers.ref.spacing['8']}}>
                      ...
                      >
                        <div style={{display: "flex", alignItems: "flex-start", gap: layers.ref.spacing['6']}}>
                          ...
                          <div style={{ flex: "1", minWidth: "0" }}>
                            ...
                            <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{doc.subtitle}</p>
