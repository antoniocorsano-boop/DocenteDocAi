...
const SuggestionBanner: React.FC<SuggestionBannerProps> = ({ suggestion, onAction }) => {
  const { layers } = useTheme();
    ...
    return (
        <div
             style={{paddingTop: layers.ref.spacing['4'], paddingBottom: layers.ref.spacing['4'], paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4'], display: "flex", alignItems: "center", justifyContent: "center", gap: layers.ref.spacing['6'], cursor: "pointer", borderBottom: "1px solid " + layers.sys.colors.outline, zIndex: Z_INDEX.notification.banner}}
            onClick={onAction}
            role="button"
...
export const App: React.FC = () => {
    ...
    try {
        ...
        return <div style={{color: 'red', padding: layers.ref.spacing['8'], fontFamily: 'monospace', background: layers.sys.colors.surfaceVariant, fontSize: '1.2rem', whiteSpace: 'pre-wrap'}}>
