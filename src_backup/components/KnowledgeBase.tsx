        ...
        <div  style={{maxWidth: "100%", marginLeft: "auto", marginRight: "auto", width: "100%", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>
            <div  style={{display: "flex", flexDirection: "column", justifyContent: "space-between", gap: layers.ref.spacing['8'], marginBottom: layers.ref.spacing['8']}}>
                <SectionHeader 
                    ...
                    icon="database"
                />
                <M3Button onClick={() => setIsAddSourceModalOpen(true)} variant="filled" style={{ borderRadius: ref.shape[] }} style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
                    <span style={{
  fontFamily: 'Material Symbols Outlined'
}}>add_circle</span>
                    Carica Documenti
            ...
            <InfoCard 
                ...
                icon="bolt"
                variant="primary"
                style={{ backgroundColor: sys.colors.primary-container/20 }} style={{marginBottom: layers.ref.spacing['8']}}
            />
