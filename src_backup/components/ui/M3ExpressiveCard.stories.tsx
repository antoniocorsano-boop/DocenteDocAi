...
export const WithChildren: Story = {
  args: {
    ...
    color: 'primary',
    children: (
      <div style={{ marginTop: ref.spacing[16], fontSize: 'var(--md-sys-spacing-3)', opacity: 0.8 }}>
...
export const ColorGrid: Story = {
  ...
  render: () => {
    ...
    return (
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: ref.spacing[16] }}>
        {colors.map((color) => (
          <M3ExpressiveCard
            key={color}
            icon="palette"
