...
export const Multiple: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: ref.spacing[16], padding: ref.spacing[32] }}>
...
export const InContext: Story = {
  ...
  render: () => (
    <div style={{ padding: ref.spacing[32], background: 'var(--md-sys-color-surface-container)', borderRadius: 'var(--md-sys-spacing-2)' }}>
      <h3 style={{ marginBottom: ref.spacing[16] }}>AI Response Generated With Context:</h3>
      <div style={{ marginBottom: ref.spacing[16] }}>
        <p>
