...
export const WithChildren: Story = {
  args: {
    ...
    variant: 'primary',
    children: (
      <ul style={{ marginTop: ref.spacing[16], paddingLeft: '1.5rem' }}>
...
export const Dismissible: Story = {
  render: () => {
    ...
    if (!visible) {
      return <div style={{ padding: ref.spacing[32] }}>Card dismissed. (You can refresh to see it again)</div>;
    }
...
export const Multiple: Story = {
  render: () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', padding: ref.spacing[32] }}>
      <InfoCard
        title="Welcome Back"
