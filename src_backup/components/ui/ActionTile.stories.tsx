...
export const Multiple: Story = {
  ...
  render: () => (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: ref.spacing[16], padding: ref.spacing[32] }}>
      <ActionTile
        title="Create Lesson"
...
export const IconVariations: Story = {
  ...
  render: () => (
    <div style={{ display: 'flex', gap: ref.spacing[16], padding: ref.spacing[32], flexWrap: 'wrap' }}>
