    ...
    children: (
      <div style={{ color: sys.colors.white }} style={{ marginLeft: "auto", marginRight: "auto", textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: "var(--md-sys-spacing-4)", justifyContent: "center" }}>
          <button  style={{ backgroundColor: "white", color: "var(--md-sys-color-primary)", borderRadius: ref.spacing[9999], fontWeight: "500" }}>
            Get Started
          </button>
          <button style={{ color: sys.colors.white }} style={{ border: "1px solid var(--md-sys-color-outline)", borderRadius: ref.spacing[9999], fontWeight: "500" }}>
            Learn More
          </button>
        </div>
      </div>
