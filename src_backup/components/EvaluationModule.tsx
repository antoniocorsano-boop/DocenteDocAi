...
const EvaluationModule: React.FC<EvaluationModuleProps> = ({ 
    ...
    const renderEvaluationGrid = () => (
        <div 
             style={{border: "1px solid layers.sys.colors.outline", borderRadius: 'calc(var(--shape-xl) * var(--sys-radius-multiplier))' }}
        >
            <table >
                <thead>
                    <tr style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]/50 }}>
                        <th style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]/80 }} style={{borderBottom: "1px solid layers.sys.colors.outline", borderRight: "1px solid layers.sys.colors.outline"}}>
                            <div  style={{paddingTop: layers.ref.spacing['4'], paddingBottom: layers.ref.spacing['4'], fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", color: "layers.sys.colors.primary"}}>Studente</div>
                        </th>
                        <th  style={{textAlign: "center", width: ref.spacing[80], borderBottom: "1px solid layers.sys.colors.outline", fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", color: "layers.sys.colors.primary"}}>Media</th>
                        <th  style={{textAlign: "center", width: ref.spacing[80], borderBottom: "1px solid layers.sys.colors.outline", fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", color: "layers.sys.colors.primary"}}>Trend</th>
                        {prove.map(p => (
                            <th key={p.id}  style={{textAlign: "center", borderBottom: "1px solid layers.sys.colors.outline", padding: layers.ref.spacing['6']}}>
                                <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%" }}>
                                    <div style={{ backgroundColor: sys.colors.primary/10 }} style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['8'], marginBottom: layers.ref.spacing['4'], borderRadius: ref.spacing[9999], border: "1px solid layers.sys.colors.outline"}}>
                                        <span  style={{color: "layers.sys.colors.primary"}}>{getTestTypeIcon(p.tipo)}</span>
                                        <span  style={{fontWeight: "900", color: "layers.sys.colors.primary"}}>{new Date(p.data).toLocaleDateString('it-IT', { day: '2-digit', month: '2-digit' })}</span>
                                    </div>
                                    <span style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontWeight: "bold", textTransform: "uppercase", letterSpacing: "-0.005em" }} title={p.titolo}>{p.titolo}</span>
                                </div>
                            </th>
                        ))}
                        {prove.length === 0 && <th style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{textAlign: "center", fontWeight: "normal", borderBottom: "1px solid layers.sys.colors.outline"}}>Nessuna prova</th>}
                    </tr>
                </thead>
                <tbody >
                    {filteredStudents.map(student => {
                        ...
                        return (
                            <tr key={student.id}  style={{ transition: "color 300ms" }}>
                                <td style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]/90 }} style={{borderRight: "1px solid layers.sys.colors.outline"}}>
                                    <div
                                    ...
                                    >
                                        ...
                                        <div style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "bold", fontSize: "0.875rem", transition: "color 300ms" }}>
                                            {student.cognome} {student.nome}
                                        </div>
                                    </div>
                                </td>
                                <td style={{ textAlign: "center", fontWeight: "900", fontSize: ref.spacing[16] }}>
                                    {performance.grade ? (
                                    ...
                                    return (
                                        ...
                                        >
                                            {voteValue ? (
                                                ...
                                                <div style={{ borderRadius: ref.shape[] }} style={{ width: ref.spacing[32], height: ref.spacing[32], display: "flex", alignItems: "center", justifyContent: "center", marginLeft: "auto", marginRight: "auto" }}>
                                                    <span style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant/20 }} style={{ fontSize: "0.875rem" }}>add</span>
                                                </div>
                                            )}
                                            {hasCompetencies && (
                                                <span  style={{width: "0.5rem", height: "0.5rem", backgroundColor: "layers.sys.colors.tertiary", borderRadius: ref.spacing[9999]}} title="Competenze valutate"></span>
                                            )}
                                        </td>
                                    )
                                })}
                                {prove.length === 0 && <td style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ textAlign: "center" }}>-</td>}
                            </tr>
                        )
                    })}
            ...
            {filteredStudents.map(student => {
                ...
                return (
                    <div 
                        ...
                        onClick={() => setViewingStudent(student)}
                    >
                        <div style={{ backgroundColor: sys.colors.primary/5 }} style={{ width: ref.spacing[96], height: ref.spacing[96], borderRadius: ref.spacing[9999], transition: "transform 300ms" }}></div>
                        
                        <div  style={{ display: "flex", alignItems: "center" }}>
                            <Avatar name={`${student.nome} ${student.cognome}`} size="lg"  />
                            <div style={{ flexGrow: "1", minWidth: "0" }}>
                                <h3 style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "900", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", fontSize: "1.125rem", letterSpacing: "-0.005em" }}>{student.cognome} {student.nome}</h3>
                            ...
                            <span style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant/40 }} style={{ transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)" }}>chevron_right</span>
                        </div>
                    </div>
                );
            })}
    ...
    const renderRiskView = () => (
        <div  style={{display: "grid", gridTemplateColumns: "1fr", gap: layers.ref.spacing['8']}}>
            {atRiskStudents.length > 0 ? atRiskStudents.map(student => {
                ...
                return (
                    ...
                    >
                        <div  style={{padding: layers.ref.spacing['8'], opacity: "0.1", transition: "opacity 300ms"}}>
                            <span style={{ color: sys.colors.6xl }} style={{color: "layers.sys.colors.error"}}>warning</span>
                        </div>
                        ...
                        <div  style={{padding: layers.ref.spacing['6']}}>
                            <div style={{display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: layers.ref.spacing['6']}}>
                                <div style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
                                    <Avatar name={`${student.nome} ${student.cognome}`} size="lg"  />
                                    <div>
                                        <h3 style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "900", fontSize: "1.125rem", letterSpacing: "-0.005em" }}>{student.cognome} {student.nome}</h3>
                                        <p style={{ color: sys.colors.[10px], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ fontWeight: "900", textTransform: "uppercase", opacity: "0.6" }}>Classe {student.classe}</p>
                                    </div>
                                </div>
                            </div>
                            
                            <div style={{ backgroundColor: sys.colors.error/10, borderRadius: ref.shape[] }} style={{color: "layers.sys.colors.error", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4'], paddingTop: layers.ref.spacing['4'], paddingBottom: layers.ref.spacing['4'], fontSize: "0.75rem", fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", border: "1px solid layers.sys.colors.outline", marginBottom: layers.ref.spacing['6'], display: "inline-block"}}>
                                Media insufficiente: {grade}
                            </div>

                            <p style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{marginBottom: layers.ref.spacing['8'], fontWeight: "500", lineHeight: "1.625"}}>
                            ...
                            <div style={{display: "flex", gap: layers.ref.spacing['6']}}>
                                <button 
                                    ...
                                    style={{ backgroundColor: sys.colors.error, color: sys.colors.white, borderRadius: ref.shape[], color: sys.colors.[10px] }} style={{ flexGrow: "1", fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)" }}
                                >
                                    Piano Inclusione
                                </button>
                                <button 
                                    onClick={(e) => { e.stopPropagation(); setViewingStudent(student); }} 
                                    style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-high)]est/50, color: sys.colors.[var(--md-sys-color-on-surface)], borderRadius: ref.shape[], color: sys.colors.[10px] }} style={{ fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)" }}
                                >
                                    Analizza
                                </button>
                            </div>
                ...
                <div >
                    <div style={{ padding: ref.spacing[12] }} style={{ textAlign: "center" }}>
                        <span style={{ color: sys.colors.6xl }} style={{color: "layers.sys.colors.tertiary", marginBottom: layers.ref.spacing['8'], opacity: "0.4"}}>verified_user</span>
                        <h3 style={{ color: sys.colors.[var(--md-sys-typescale-headline-small)], color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "900" }}>Nessuna criticit�</h3>
                        <p style={{ color: sys.colors.[var(--md-sys-typescale-body-large)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{marginTop: layers.ref.spacing['4']}}>Tutti gli studenti mantengono una media sufficiente.</p>
                    </div>
                </div>
            )}
        </div>
    ...
    return (
        <div  style={{ maxWidth: "100%", marginLeft: "auto", marginRight: "auto", width: "100%" }}>
            <div  style={{display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "flex-start", gap: layers.ref.spacing['8']}}>
                <div>
                    <h1 style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "900", letterSpacing: "-0.005em" }}>Registro Valutazioni</h1>
                    <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{fontWeight: "500", marginTop: layers.ref.spacing['4'], opacity: "0.7"}}>Gestione voti, competenze e monitoraggio performance</p>
                </div>
                ...
                <div style={{ borderRadius: ref.shape[2] }} style={{display: "flex", flexWrap: "wrap", alignItems: "center", gap: layers.ref.spacing['8'], padding: layers.ref.spacing['6']}}>
                    <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]/50, borderRadius: ref.shape[] }} style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['6'], paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4'], paddingTop: layers.ref.spacing['4'], paddingBottom: layers.ref.spacing['4'], border: "1px solid layers.sys.colors.outline"}}>
                        <span  style={{color: "layers.sys.colors.primary", fontSize: "1.25rem"}}>class</span>
                        <select 
                            id="class-select" 
                            value={selectedClass} 
                            onChange={e => setSelectedClass(e.target.value)} 
                            style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ backgroundColor: "transparent", fontWeight: "900", fontSize: "0.75rem", textTransform: "uppercase", letterSpacing: "0.1em", border: "none", cursor: "pointer" }}
                        >
                            {userClasses.map(c => <option key={c} value={c} style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{backgroundColor: "layers.sys.colors.surface"}}>{c}</option>)}
                        </select>
                    </div>
                    
                    <div style={{display: "flex", gap: layers.ref.spacing['6']}}>
                        <button onClick={() => setIsAddProvaModalOpen(true)} style={{ borderRadius: ref.shape[], color: sys.colors.[10px] }} style={{backgroundColor: "layers.sys.colors.primary", color: "layers.sys.colors.on-primary", fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
                            <span  style={{ fontSize: "1.125rem" }}>add</span>
                            Nuova Prova
                        </button>
                        <button onClick={() => setIsExportModalOpen(true)} style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-high)]est, color: sys.colors.[var(--md-sys-color-on-surface)], borderRadius: ref.shape[], color: sys.colors.[10px] }} style={{fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", display: "flex", alignItems: "center", gap: layers.ref.spacing['8']}}>
            ...
            <div style={{ borderRadius: ref.shape[25] }} style={{border: "1px solid layers.sys.colors.outline"}}>
                <div style={{ backgroundColor: sys.colors.surface/30 }} style={{padding: layers.ref.spacing['8'], borderBottom: "1px solid layers.sys.colors.outline"}}>
                    <div  style={{display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "space-between", gap: layers.ref.spacing['6']}}>
                        <div>
                            <h2 style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "900", letterSpacing: "-0.005em" }}>Valutazione Unificata</h2>
                            <p style={{ color: sys.colors.[10px], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", opacity: "0.6", marginTop: layers.ref.spacing['4']}}>Griglia voti e competenze trasversali</p>
                        </div>
                        <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]/50, padding: ref.spacing[15], borderRadius: ref.shape[] }} style={{display: "flex", border: "1px solid layers.sys.colors.outline"}}>
                            {[
                                ...
                                >
                                    ...
                                    {tab.label}
                                    {tab.badge && (
                                        <span style={{ backgroundColor: sys.colors.error, color: sys.colors.white, color: sys.colors.[10px] }} style={{ width: "1.25rem", height: "1.25rem", borderRadius: ref.spacing[9999], display: "flex", alignItems: "center", justifyContent: "center" }}>
                                            {tab.badge}
                                        </span>
                                    )}
                                </button>
