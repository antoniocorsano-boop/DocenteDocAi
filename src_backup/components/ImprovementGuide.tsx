                ...
                <div  style={{padding: layers.ref.spacing['8']}}>
                    {competencyLevelData.map(compData => (
                        <div key={compData.name} style={{marginTop: layers.ref.spacing['4']}}>
                            <h3 style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ fontSize: "0.875rem", fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", opacity: "0.7" }}>{compData.name}</h3>
                            <BarChart
