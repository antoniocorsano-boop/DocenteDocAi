                ...
                <div style={{marginTop: layers.ref.spacing['4']}}>
                    ...
                    <div style={{gap: layers.ref.spacing['3']}}>
                        {recentDocs.length > 0 ? recentDocs.map(doc => (
                            ...
                            <div style={{ borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['8'], textAlign: "center", opacity: "0.5"}}>
                                <span style={{ color: sys.colors.4xl }} style={{marginBottom: layers.ref.spacing['8']}}>drafts</span>
