...
const EditSlotModal: React.FC<EditSlotModalProps> = ({
  ...
  paddingRight: layers.ref.spacing['4']}}>
                    <p style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)] }} style={{color: "layers.sys.colors.primary", textTransform: "uppercase"}}>{slot.giorno} • {slot.ora}</p>
                </div>
                ...
                <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]est, borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['8'], border: "1px solid layers.sys.colors.outline"}}>
