...
const ConsiglioClasseWizard: React.FC<ConsiglioClasseWizardProps> = (props) => {
            ...
            <M3DialogContent style={{gap: layers.ref.spacing['6']}}>
                ...
                >
                 ...
                 <div style={{gap: layers.ref.spacing['2']}}>
                    <label  style={{color: "layers.sys.colors.primary", fontWeight: "900", textTransform: "uppercase", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>Periodo di Valutazione</label>
                    <TabGroup
                        tabs={[
  ...
  fontFamily: 'Material Symbols Outlined'
    ...
    const renderStep2 = () => (
        <>
            <M3DialogContent style={{gap: layers.ref.spacing['6']}}>
                <div style={{ backgroundColor: sys.colors.primary-container/20, borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['5'], border: "1px solid layers.sys.colors.outline", display: "flex", alignItems: "center", justifyContent: "space-between"}}>
                    <div>
                        <p style={{ color: sys.colors.[9px] }} style={{fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em", color: "layers.sys.colors.primary"}}>Context Active</p>
                        <h3 style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "900" }}>{selectedClass} • {periodo === 'primo-quadrimestre' ? '1Q' : 'Finale'}</h3>
                    </div>
                ...
                <div  style={{gap: layers.ref.spacing['3']}}>
                    <button onClick={handleGeneratePdf} style={{ borderRadius: ref.shape[] }} style={{ transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", width: "100%", textAlign: "left" }}>
                ...
                <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{textAlign: "center", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>
        ...
        return (
             ...
             >
                <M3DialogContent  style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
                    <div  style={{borderRadius: ref.spacing[9999], height: ref.spacing[64], width: ref.spacing[64], borderBottom: "4px solid layers.sys.colors.outline", borderColor: "layers.sys.colors.primary", marginBottom: layers.ref.spacing['6']}}></div>
                    <p  style={{fontWeight: "900", color: "layers.sys.colors.primary"}}>{loadingMessage}</p>
                </M3DialogContent>
            </M3Dialog>
        )
    }
