    ...
    return (
        ...
        >
            <M3DialogContent  style={{ overflowY: "auto" }}>
                <h3  style={{color: "layers.sys.colors.primary", marginBottom: layers.ref.spacing['8']}}>Architettura "Local-First" e Privacy</h3>
                <p style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{marginBottom: layers.ref.spacing['8']}}>
                ...
                <h3  style={{color: "layers.sys.colors.secondary", marginBottom: layers.ref.spacing['8']}}>Backup su Google Drive (BYOC)</h3>
                <p style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{marginBottom: layers.ref.spacing['8']}}>
                ...
                <ul style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{gap: layers.ref.spacing['4']}}>
                    <li>
                ...
                <h3  style={{color: "layers.sys.colors.tertiary", marginBottom: layers.ref.spacing['8']}}>Sincronizzazione Automatica e Manuale</h3>
                <ul style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{gap: layers.ref.spacing['4']}}>
                    <li>
