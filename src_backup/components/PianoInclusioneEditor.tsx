                    ...
                    <div >
                        ...
                        <InfoCard variant="elevated" >
                            <div style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['8'], marginBottom: layers.ref.spacing['8']}}>
                                <span  style={{color: "layers.sys.colors.primary"}}>subject</span>
                                <h3 style={{fontSize: "0.875rem", fontWeight: "bold", color: "layers.sys.colors.primary", textTransform: "uppercase", letterSpacing: "0.05em"}}>
                                    Obiettivi per Materia (PEI/PDP)
                                </h3>
                            </div>
                            <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{fontSize: "0.75rem", marginBottom: layers.ref.spacing['8']}}>
                            ...
                            <div >
                                {settings.disciplines.map(materia => (
                                    <div key={materia} >
                                        <div >
                                            <label >
                                                <span style={{ color: sys.colors.[var(--md-sys-spacing-4)] }}>book</span>
                                                {materia}
                                            </label>
                                            <M3Button
                                                type="button"
