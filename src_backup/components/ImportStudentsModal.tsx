...
const ImportStudentsModal: React.FC<ImportStudentsModalProps> = ({ onClose, onImport, userClasses, knowledgeBase }) => {
                ...
                return (
                    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
                        <div>
                            ...
                            {targetClass === 'AUTO' && <p style={{ color: sys.colors.[10px], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{marginTop: layers.ref.spacing['4'], paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>Il file CSV deve contenere una colonna con il nome della classe (es. "1A", "2B").</p>}
                        </div>
                        ...
                        {importSource === 'file' ? (
                            <div>
                                ...
                                >
                                    <input {...getInputProps()} />
                                    {isLoading ? (
                                        <div  style={{borderRadius: ref.spacing[9999], height: "2.5rem", width: "2.5rem", borderColor: "layers.sys.colors.primary"}}></div>
                                    ) : (
                                        <>
                                            ...
                                            <h3 style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontWeight: "bold", textAlign: "center" }}>Trascina il file .csv o .xlsx qui</h3>
                            ...
                            <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['8']}}>
                                <p  style={{textTransform: "uppercase", color: "layers.sys.colors.primary", fontWeight: "bold"}}>Seleziona un file CSV dalla KB</p>
                                <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)], borderRadius: ref.shape[] }} style={{overflowY: "auto", padding: layers.ref.spacing['8'], border: "1px solid layers.sys.colors.outline", display: "flex", flexDirection: "column", gap: layers.ref.spacing['4']}}>
                                    {knowledgeBase.length > 0 ? (
                                        knowledgeBase.map(entry => (
                                            <div
                                                key={entry.id}
                                                onClick={() => handleKbFileSelect(entry)}
                                                style={{ borderRadius: ref.shape[] }} style={{display: "flex", alignItems: "center", gap: layers.ref.spacing['6'], padding: layers.ref.spacing['6'], transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", cursor: "pointer"}}
                                            >
                                                <span style={{ backgroundColor: sys.colors.primary-container/30, borderRadius: ref.shape[] }} style={{color: "layers.sys.colors.primary", padding: layers.ref.spacing['8'], transition: "color 300ms"}}>description</span>
                                                <span style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{ fontSize: "0.875rem", fontWeight: "bold", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flexGrow: "1" }}>{entry.fileName}</span>
                                                <span style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{ opacity: "0.5", transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)" }}>chevron_right</span>
                                            </div>
                                        ))
                                    ) : (
                                        <div style={{padding: layers.ref.spacing['8'], textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: layers.ref.spacing['8'], opacity: "0.6"}}>
                                            <span style={{ color: sys.colors.3xl }}>folder_off</span>
                        ...
                        {error && (
                            <div style={{ color: sys.colors.on-error-container, borderRadius: ref.shape[] }} style={{display: "flex", alignItems: "flex-start", gap: layers.ref.spacing['6'], padding: layers.ref.spacing['8'], backgroundColor: "layers.sys.colors.error-container"}}>
                                <span style={{
  fontFamily: 'Material Symbols Outlined'
                        ...
                        {infoMessage && (
                            <div style={{ color: sys.colors.on-tertiary-container, borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['5'], backgroundColor: "layers.sys.colors.tertiary-container"}}>
            ...
            case 'mapping':
                return (
                    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
                        ...
                        <p style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)], color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>
                        ...
                        <div>
                            <h4  style={{textTransform: "uppercase", color: "layers.sys.colors.primary", fontWeight: "bold", marginBottom: layers.ref.spacing['6'], paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>Anteprima Dati (Prime 3 righe)</h4>
                            <div style={{ borderRadius: ref.shape[] }} style={{overflowX: "auto", border: "1px solid layers.sys.colors.outline"}}>
                                <table style={{ width: "100%", fontSize: "0.875rem", textAlign: "left" }}>
                                    <thead style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant, backgroundColor: sys.colors.[var(--md-sys-color-surface-container-high)] }} style={{ fontSize: "0.75rem", textTransform: "uppercase", fontWeight: "bold" }}>
                                        <tr>
                                    ...
                                    <tbody >
                                        {csvData.slice(0, 3).map((row, index) => (
                                            <tr key={index}  style={{backgroundColor: "layers.sys.colors.surface", transition: "color 300ms"}}>
                                                {csvHeaders.map(h => <td key={h} style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4'], whiteSpace: "nowrap", fontWeight: "500"}}>{row[h]}</td>)}
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
            ...
            case 'confirm':
                return (
                    <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6']}}>
                        ...
                        {targetClass === 'AUTO' && (
                            <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)], borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['8'], border: "1px solid layers.sys.colors.outline", fontSize: "0.875rem", display: "flex", gap: layers.ref.spacing['6'], alignItems: "flex-start"}}>
                                <span  style={{color: "layers.sys.colors.primary", fontSize: "1.25rem"}}>info</span>
                                <div>
                                    <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{fontWeight: "bold", marginBottom: layers.ref.spacing['4']}}>Nota Importante</p>
                                    <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }}>Gli studenti verranno assegnati alle classi indicate nel file. Se una classe nel file non esiste nelle tue Impostazioni, lo studente verrà comunque importato ma la classe sarà creata implicitamente.</p>
                                </div>
                            </div>
                        )}

                        <div style={{ borderRadius: ref.shape[] }} style={{overflowY: "auto", border: "1px solid layers.sys.colors.outline"}}>
                            <table style={{ width: "100%", fontSize: "0.875rem", textAlign: "left" }}>
                                <thead style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant, backgroundColor: sys.colors.[var(--md-sys-color-surface-container-high)] }} style={{ fontSize: "0.75rem", textTransform: "uppercase", fontWeight: "bold" }}>
                                    <tr>
                                ...
                                <tbody >
                                    {studentsToImport.map((student, index) => (
                                        <tr key={index}  style={{backgroundColor: "layers.sys.colors.surface", transition: "color 300ms"}}>
                                            <td style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4'], fontWeight: "bold"}}>{student.cognome}</td>
                                            <td style={{ color: sys.colors.[var(--md-sys-color-on-surface)] }} style={{paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>{student.nome}</td>
                                            <td  style={{paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}><span style={{ color: sys.colors.on-primary-container }} style={{paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4'], borderRadius: ref.spacing[9999], backgroundColor: "layers.sys.colors.primary-container", fontWeight: "900", fontSize: "0.75rem"}}>{student.classe}</span></td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
