...
const SmartDocumentEditor: React.FC<SmartDocumentEditorProps> = ({ initialContent, documentTitle, onClose, aiSettings, onSaveToKb }) => {
  ...
  fontFamily: 'Material Symbols Outlined'
                ...
                <div  style={{ display: "none" }}>
                    ...
                    <button onClick={handleAiTable}  style={{color: "layers.sys.colors.primary"}} title="Tabella AI" aria-label="Genera tabella con AI"><span  aria-hidden="true">table_chart</span></button>
                </div>
                ...
                <div >
                    ...
                    <button onClick={handlePrint}  title="Stampa / PDF" aria-label="Stampa o salva come PDF">
                        <span style={{ color: sys.colors.[var(--md-sys-typescale-body-medium)] }} aria-hidden="true">print</span>
                    </button>
                    {onSaveToKb && (
