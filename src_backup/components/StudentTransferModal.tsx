        ...
        >
            <M3DialogContent style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-high)]/30 }}>
                <div style={{display: "flex", flexDirection: "column", gap: layers.ref.spacing['6'], paddingTop: layers.ref.spacing['4'], paddingBottom: layers.ref.spacing['4']}}>
                    <div style={{ backgroundColor: sys.colors.secondary-container/10, borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['8'], border: "1px solid layers.sys.colors.outline"}}>
                    ...
                    {mode === 'change_class' ? (
                        <div style={{ backgroundColor: sys.colors.[var(--md-sys-color-surface-container-low)]est/50, borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['8'], border: "1px solid layers.sys.colors.outline", display: "flex", flexDirection: "column", gap: layers.ref.spacing['8']}}>
                            <h3  style={{color: "layers.sys.colors.primary", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>Nuova Destinazione</h3>
                        ...
                        <div style={{ backgroundColor: sys.colors.error-container/10, borderRadius: ref.shape[] }} style={{padding: layers.ref.spacing['8'], border: "1px solid layers.sys.colors.outline", display: "flex", flexDirection: "column", gap: layers.ref.spacing['8']}}>
                            <h3  style={{color: "layers.sys.colors.error", paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>Motivazione Uscita</h3>
                            <SelectField
                                label="Esito"
                                value={outcome}
                                ...
                                fullWidth
                            />
                            <p style={{ color: sys.colors.[var(--md-sys-color-on-surface)]-variant }} style={{paddingLeft: layers.ref.spacing['4'], paddingRight: layers.ref.spacing['4']}}>
