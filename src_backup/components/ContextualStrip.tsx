    ...
    return (
        <div className={`contextual-strip ${visible ? 'visible' : 'hidden-strip'}`}>
            ...
            <div  style={{display: "flex", alignItems: "flex-start", gap: layers.ref.spacing['6'], flexGrow: "1", minWidth: "0"}}>
                <div style={{ backgroundColor: sys.colors.on-tertiary-container/20 }} style={{ width: "1.5rem", height: "1.5rem", borderRadius: ref.spacing[9999], display: "flex", alignItems: "center", justifyContent: "center", flexShrink: "0" }}>
