...
const SpacingDocumentation = () => (
  <div style={{ padding: 'var(--md-sys-spacing-6)', fontFamily: 'var(--font-family)' }}>
    <h1 style={{ fontSize: ref.spacing[36], fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginBottom: 'var(--md-sys-spacing-4)' }}>Spacing System</h1>
    ...
    <h2 style={{ fontSize: ref.spacing[28], fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginTop: ref.spacing[40], marginBottom: ref.spacing[20] }}>Spacing Scale</h2>
    ...
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 'var(--md-sys-spacing-6)', marginBottom: 'var(--md-sys-spacing-8)' }}>
      {[
        { value: ref.spacing[0], description: 'No spacing - elements touching' },
        { value: ref.spacing[2], description: 'Minimal spacing' },
        ...
        { value: ref.spacing[20], description: 'Medium-large spacing' },
        ...
        { value: ref.spacing[40], description: 'Extra large spacing (5 units)' },
        { value: 'var(--md-sys-spacing-12)', description: 'Extra extra large spacing (6 units)' },
        { value: ref.spacing[64], description: 'Largest spacing (8 units)' },
      ].map((space) => (
        <SpacingSwatch key={space.value} value={space.value} description={space.description} />
      ))}
    </div>

    <h2 style={{ fontSize: ref.spacing[28], fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginTop: ref.spacing[40], marginBottom: ref.spacing[20] }}>Common Spacing Combinations</h2>
    ...
    <h2 style={{ fontSize: ref.spacing[28], fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginTop: ref.spacing[40], marginBottom: ref.spacing[20] }}>Padding Patterns</h2>
    ...
    <div style={{ padding: 'var(--md-sys-spacing-4)', backgroundColor: 'var(--md-sys-color-surface-container)', borderRadius: 'var(--md-sys-spacing-2)', border: '1px solid var(--md-sys-color-outline)', marginBottom: 'var(--md-sys-spacing-4)' }}>
      ...
      <div style={{ padding: 'var(--md-sys-spacing-3)', backgroundColor: 'var(--md-sys-color-surface-container-low)', borderRadius: 'var(--md-sys-spacing-1)', fontSize: 'var(--md-sys-typescale-body-medium-size)' }}>
    ...
    <div style={{ marginBottom: 'var(--md-sys-spacing-6)' }}>
      <label style={{ display: 'block', fontSize: 'var(--md-sys-spacing-3)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginBottom: 'var(--md-sys-spacing-1)' }}>
        Input Label
      </label>
      <input
        type="text"
    ...
    <h2 style={{ fontSize: ref.spacing[28], fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginTop: ref.spacing[40], marginBottom: ref.spacing[20] }}>Best Practices</h2>
    <ol style={{ fontSize: 'var(--md-sys-typescale-body-medium-size)', lineHeight: 'var(--md-sys-spacing-6)', color: sys.colors.333, paddingLeft: ref.spacing[20] }}>
    ...
    <div style={{ display: 'flex', alignItems: 'flex-start', gap: 'var(--md-sys-spacing-2)', marginBottom: 'var(--md-sys-spacing-2)' }}>
      <div
        style={{
          ...
          width: value === ref.spacing[0] ? ref.spacing[2] : value,
          height: value === ref.spacing[0] ? ref.spacing[2] : 'var(--md-sys-spacing-8)',
          borderRadius: 'var(--md-sys-spacing-1)',
          flexShrink: 0,
        }}
      />
