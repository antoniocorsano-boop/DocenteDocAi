...
export const baseDesignSystem: Readonly<DesignSystemDefinition> = Object.freeze({
  ...
  typography: {
    ...
    labelSmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: '11px', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-spacing-4)' }, description: 'Style for small labels.', cssVar: '--typography-label-small' },
  ...
  spacing: {
    '1': { value: '0.25rem', description: 'var(--md-sys-spacing-1)', cssVar: '--spacing-1' },
    '2': { value: '0.5rem', description: 'var(--md-sys-spacing-2)', cssVar: '--spacing-2' },
    '3': { value: '0.75rem', description: 'var(--md-sys-spacing-3)', cssVar: '--spacing-3' },
    '4': { value: '1rem', description: 'var(--md-sys-spacing-4)', cssVar: '--spacing-4' },
    '6': { value: '1.5rem', description: 'var(--md-sys-spacing-6)', cssVar: '--spacing-6' },
    '8': { value: '2rem', description: 'var(--md-sys-spacing-8)', cssVar: '--spacing-8' },
    '12': { value: '3rem', description: 'var(--md-sys-spacing-12)', cssVar: '--spacing-12' },
