...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: bg-
...
🟡 **WARNING:** Legacy CSS class detected: sys-shape
`borderRadius: 'var(--md-sys-shape-corner-large)',`
🟡 **WARNING:** Legacy CSS class detected: sys-spacing
`padding: 'var(--md-sys-spacing-8)',`
🟡 **WARNING:** Legacy CSS class detected: sys-spacing
`gap: 'var(--md-sys-spacing-4)',`
🟡 **WARNING:** Legacy CSS class detected: sys-elevation
...
`boxShadow: 'var(--md-sys-elevation-level1)',`
🟡 **WARNING:** Legacy CSS class detected: sys-color
`border: `1px solid var(--md-sys-color-outline-variant)``🟡 **WARNING:** Legacy CSS class detected: sys-spacing
  `gap: 'var(--md-sys-spacing-1)'`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `color: 'var(--md-sys-color-on-surface)',`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `color: 'var(--md-sys-color-on-surface-variant)',`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `backgroundColor: 'var(--md-sys-color-surface-variant)',`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `color: 'var(--md-sys-color-on-surface-variant)',`🔵 **INFO:** Consider using M3Typography for text: "chevron_right"
  `>`🔵 **INFO:** Inline style without MD3 tokens detected
  `<span className="material-symbols-outlined" style={{ fontSize: '28px' }}>`🔵 **INFO:** Inline style without MD3 tokens detected
  `style={{`🔵 **INFO:** Inline style without MD3 tokens detected
  `style={{`
...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: sys-surface
`<div style={{ padding: '2rem', background: 'var(--sys-surface-container)', borderRadius: '8px' }}>`
🟡 **WARNING:** Legacy CSS class detected: sys-on
...
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "AI Response Generated With Context:"
`<h3 style={{ marginBottom: '1rem' }}>AI Response Generated With Context:</h3>`
🔵 **INFO:** Consider using M3Typography for text: "Here&apos;s a personalized lesson summary based on your previous progress and
current learning objectives..."
`<p>`
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "Hover over the chips to see what context the AI system is using:"
`<p style={{ fontSize: '0.9rem', color: 'var(--sys-on-surface-variant)' }}>`
🔵 **INFO:** Inline style without MD3 tokens detected
...
🟡 **WARNING:** Legacy CSS class detected: text-
...
🟡 **WARNING:** Legacy CSS class detected: text-
`<span className="text-xs font-extrabold text-tertiary uppercase tracking-widest">{label}</span>`
🟡 **WARNING:** Legacy CSS class detected: border-
`className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🟡 **WARNING:** Legacy CSS class detected: px-3
`className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🟡 **WARNING:** Legacy CSS class detected: py-1
`className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🟡 **WARNING:** Legacy CSS class detected: gap-2
`className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🟡 **WARNING:** Legacy CSS class detected: opacity-60
`className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🟡 **WARNING:** Legacy CSS class detected: opacity-100
`className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🟡 **WARNING:** Legacy CSS class detected: cursor-help
`className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🔵 **INFO:** Consider using M3Typography for text: "("
`const AiMemoryChip: React.FC<AiMemoryChipProps> = ({ label }) => (`
🔵 **INFO:** Consider using M3Typography for text: "psychology"
`<span className="material-symbols-outlined text-sm text-tertiary font-bold animate-pulse">psychology</span>`
...
🟡 **WARNING:** Legacy CSS class detected: gap-8
`<div className={`flex ${inline ? 'flex-row gap-8' : 'flex-col gap-8'} items-center justify-center`}>`
🟡 **WARNING:** Legacy CSS class detected: gap-8
`<div className={`flex ${inline ? 'flex-row gap-8' : 'flex-col gap-8'} items-center justify-center`}>`
🟡 **WARNING:** Legacy CSS class detected: flex-row
`<div className={`flex ${inline ? 'flex-row gap-8' : 'flex-col gap-8'} items-center justify-center`}>`
🟡 **WARNING:** Legacy CSS class detected: flex-col
`<div className={`flex ${inline ? 'flex-row gap-8' : 'flex-col gap-8'} items-center justify-center`}>`
🟡 **WARNING:** Legacy CSS class detected: sys-primary
`background: 'var(--sys-primary-container)',`
🟡 **WARNING:** Legacy CSS class detected: sys-primary
`background: 'conic-gradient(from 0deg, transparent 0%, var(--sys-primary) 50%, var(--sys-tertiary) 100%)',`
🟡 **WARNING:** Legacy CSS class detected: sys-tertiary
`background: 'conic-gradient(from 0deg, transparent 0%, var(--sys-primary) 50%, var(--sys-tertiary) 100%)',`
🟡 **WARNING:** Legacy CSS class detected: opacity-40
`className="absolute inset-0 rounded-full animate-pulse opacity-40"`
🔵 **INFO:** Consider using M3Typography for text: "diamond"
`<span className="material-symbols-outlined text-primary font-light" style={{ fontSize: dim.icon }}>`
🔵 **INFO:** Inline style without MD3 tokens detected
...
🟡 **WARNING:** Legacy CSS class detected: text-
`<div className={`relative flex-shrink-0 rounded-3xl overflow-hidden bg-primary-container text-on-primary-container flex items-center justify-center font-black ${sizeClasses[size]} ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: rounded-3xl
`<div className={`relative flex-shrink-0 rounded-3xl overflow-hidden bg-primary-container text-on-primary-container flex items-center justify-center font-black ${sizeClasses[size]} ${className}`}>`
🔵 **INFO:** Consider using M3Typography for text: ") : ("
...
🟡 **WARNING:** Legacy CSS class detected: sys-secondary
`color: 'var(--sys-secondary)',`
🟡 **WARNING:** Legacy CSS class detected: sys-tertiary
`color: 'var(--sys-tertiary)',`
🟡 **WARNING:** Legacy CSS class detected: sys-error
`color: 'var(--sys-error)',`
🟡 **WARNING:** Legacy CSS class detected: sys-surface
`color: 'var(--sys-surface-variant)',`
🟡 **WARNING:** Legacy CSS class detected: sys-outline
...
🔵 **INFO:** Consider using M3Typography for text: "('1');
...
🟡 **WARNING:** Legacy CSS class detected: border-
`className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: shadow-
`className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: p-5
`className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: px-4
`{description && <p className="text-[10px] text-on-surface-variant text-center opacity-60 leading-tight font-medium line-clamp-2 px-4">{description}</p>}`
🟡 **WARNING:** Legacy CSS class detected: gap-8
`className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: gap-4
`<div className="flex flex-col items-center gap-4">`
🟡 **WARNING:** Legacy CSS class detected: flex-col
`className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: flex-col
`<div className="flex flex-col items-center gap-4">`
🟡 **WARNING:** Legacy CSS class detected: rounded-2xl
`className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: rounded-xl
...
🟡 **WARNING:** Legacy CSS class detected: rounded-lg
`<div className="h-8 bg-surface-container-high rounded-lg animate-pulse" style={{ width: '70%' }} />`
🔵 **INFO:** Consider using M3Typography for text: "("
`}) => (`
🔵 **INFO:** Consider using M3Typography for text: "("
...
🟡 **WARNING:** Legacy CSS class detected: shadow-
`<div className="w-24 h-24 rounded-full bg-surface-container-high flex items-center justify-center mb-8 text-on-surface-variant/30 shadow-inner">`
🟡 **WARNING:** Legacy CSS class detected: p-16
`<div className="flex flex-col items-center justify-center p-16 text-center bg-surface-container-low/50 backdrop-blur-sm rounded-5xl border-2 border-dashed border-outline-variant/30">`
🟡 **WARNING:** Legacy CSS class detected: flex-col
`<div className="flex flex-col items-center justify-center p-16 text-center bg-surface-container-low/50 backdrop-blur-sm rounded-5xl border-2 border-dashed border-outline-variant/30">`
🟡 **WARNING:** Legacy CSS class detected: rounded-5xl
`<div className="flex flex-col items-center justify-center p-16 text-center bg-surface-container-low/50 backdrop-blur-sm rounded-5xl border-2 border-dashed border-outline-variant/30">`
🟡 **WARNING:** Legacy CSS class detected: opacity-60
`<p className="m3-body-large text-on-surface-variant max-w-sm mx-auto mt-4 font-bold opacity-60 italic">"{description}"</p>`
🔵 **INFO:** Consider using M3Typography for text: "("
...
🔵 **INFO:** Consider using M3Typography for text: "("
`}) => (`
🔵 **INFO:** Consider using M3Typography for text: "image"
`<span className="material-symbols-outlined text-4xl">image</span>`
🔵 **INFO:** Consider using M3Typography for text: "Generazione immagine..."
`<span className="text-sm font-medium">Generazione immagine...</span>`
🔵 **INFO:** Inline style without MD3 tokens detected
`style={{ aspectRatio }}`
...
**Issues:**
🟡 **WARNING:** M3Typography used but not imported
...
🔵 **INFO:** Consider using M3Typography for text: "Interactive lessons"
`<li>Interactive lessons</li>`
🔵 **INFO:** Consider using M3Typography for text: "Real-time feedback"
`<li>Real-time feedback</li>`
🔵 **INFO:** Consider using M3Typography for text: "Adaptive learning paths"
`<li>Adaptive learning paths</li>`
🔵 **INFO:** Consider using M3Typography for text: "Learn More"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Card dismissed. (You can refresh to see it again)"
...
🟡 **WARNING:** Legacy CSS class detected: shadow-
`<div className="p-5 rounded-2xl bg-white/30 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-inner border border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">`
🟡 **WARNING:** Legacy CSS class detected: p-6
`className={`m3-info-card p-6 md:p-10 shadow-xl md:shadow-2xl backdrop-blur-2xl border border-white/10 dark:border-black/10 overflow-hidden relative group transition-all duration-500 hover:shadow-primary/10 ${onClick ? 'cursor-pointer hover:scale-[1.02] active:scale-[0.98]' : ''} ${variantClasses} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: p-10
`className={`m3-info-card p-6 md:p-10 shadow-xl md:shadow-2xl backdrop-blur-2xl border border-white/10 dark:border-black/10 overflow-hidden relative group transition-all duration-500 hover:shadow-primary/10 ${onClick ? 'cursor-pointer hover:scale-[1.02] active:scale-[0.98]' : ''} ${variantClasses} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: p-5
`<div className="p-5 rounded-2xl bg-white/30 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-inner border border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">`
🟡 **WARNING:** Legacy CSS class detected: gap-8
...
🟡 **WARNING:** Legacy CSS class detected: flex-row
`<div className="flex flex-col md:flex-row gap-8 items-start relative z-10">`
🟡 **WARNING:** Legacy CSS class detected: flex-grow
`<div className="flex-grow">`
🟡 **WARNING:** Legacy CSS class detected: rounded-2xl
`<div className="p-5 rounded-2xl bg-white/30 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-inner border border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">`
🟡 **WARNING:** Legacy CSS class detected: sys-radius
`style={{ borderRadius: 'calc(var(--shape-xl) * var(--sys-radius-multiplier))' }}`
🟡 **WARNING:** Legacy CSS class detected: opacity-90
`{description && <p className="m3-body-large opacity-90 leading-relaxed">{description}</p>}`
🔵 **INFO:** Consider using M3Typography for text: "close"
...
🟡 **WARNING:** Legacy CSS class detected: border-
`<div className={`p-8 bg-surface-container-low/50 border border-outline-variant/10 flex items-center justify-between group/item hover:bg-surface-container-low transition-colors rounded-2xl ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: p-8
`<div className={`p-8 bg-surface-container-low/50 border border-outline-variant/10 flex items-center justify-between group/item hover:bg-surface-container-low transition-colors rounded-2xl ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: rounded-2xl
`<div className={`p-8 bg-surface-container-low/50 border border-outline-variant/10 flex items-center justify-between group/item hover:bg-surface-container-low transition-colors rounded-2xl ${className}`}>`
🔵 **INFO:** Consider using M3Typography for text: "("
...
🟡 **WARNING:** Legacy CSS class detected: text-
`lg: { container: 'text-4xl', badge: 'text-base px-2.5 py-1' }`
🟡 **WARNING:** Legacy CSS class detected: px-1
`sm: { container: 'text-lg', badge: 'text-xs px-1.5 py-0.5' },`
🟡 **WARNING:** Legacy CSS class detected: px-4
`md: { container: 'text-2xl', badge: 'text-sm px-4 py-1' },`
🟡 **WARNING:** Legacy CSS class detected: px-2
`lg: { container: 'text-4xl', badge: 'text-base px-2.5 py-1' }`
🟡 **WARNING:** Legacy CSS class detected: py-0
`sm: { container: 'text-lg', badge: 'text-xs px-1.5 py-0.5' },`
🟡 **WARNING:** Legacy CSS class detected: py-1
`md: { container: 'text-2xl', badge: 'text-sm px-4 py-1' },`
🟡 **WARNING:** Legacy CSS class detected: py-1
...
🟡 **WARNING:** Legacy CSS class detected: sys-color
`<div key={doc} style={{ padding: 'var(--md-sys-spacing-4)', backgroundColor: 'var(--md-sys-color-surface)', borderRadius: 'var(--md-corner-medium)', boxShadow: 'var(--md-sys-elevation1)' }}>`
🟡 **WARNING:** Legacy CSS class detected: sys-elevation1
`<div key={doc} style={{ padding: 'var(--md-sys-spacing-4)', backgroundColor: 'var(--md-sys-color-surface)', borderRadius: 'var(--md-corner-medium)', boxShadow: 'var(--md-sys-elevation1)' }}>`
🟡 **WARNING:** Legacy CSS class detected: sys-spacing
...
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "Main Content"
`<h1>Main Content</h1>`
🔵 **INFO:** Consider using M3Typography for text: "This is the main content area above the bottom app bar."
`<p>This is the main content area above the bottom app bar.</p>`
🔵 **INFO:** Consider using M3Typography for text: "Home"
`<button style={{ padding: 'var(--md-sys-spacing-3) var(--md-sys-spacing-4)' }}>Home</button>`
🔵 **INFO:** Consider using M3Typography for text: "Browse"
`<button style={{ padding: '0.75rem 1rem' }}>Browse</button>`
🔵 **INFO:** Consider using M3Typography for text: "Create"
`<button style={{ padding: '0.75rem 1rem' }}>Create</button>`
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "Document List"
`<h1>Document List</h1>`
🔵 **INFO:** Consider using M3Typography for text: "("
`{['Document 1', 'Document 2', 'Document 3'].map((doc) => (`
🔵 **INFO:** Consider using M3Typography for text: "📝 Draft"
`<button style={{ padding: '0.75rem 1rem' }}>📝 Draft</button>`
🔵 **INFO:** Consider using M3Typography for text: "📁 Folder"
...
🔵 **INFO:** Consider using M3Typography for text: "🏠 Home"
`<h1>🏠 Home</h1>`
🔵 **INFO:** Consider using M3Typography for text: "Home screen content"
`<p>Home screen content</p>`
🔵 **INFO:** Consider using M3Typography for text: "("
`].map((item) => (`
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "Document Title"
`<h1>Document Title</h1>`
🔵 **INFO:** Consider using M3Typography for text: "Document content here..."
`<p>Document content here...</p>`
🔵 **INFO:** Consider using M3Typography for text: "💾 Save"
`<button style={{ padding: 'var(--md-sys-spacing-3) var(--md-sys-spacing-6)', backgroundColor: 'var(--md-sys-color-surface-container-high)', border: 'none', borderRadius: 'var(--md-corner-small)', cursor: 'pointer' }}>`
🔵 **INFO:** Consider using M3Typography for text: "🔍 Preview"
`<button style={{ padding: 'var(--md-sys-spacing-3) var(--md-sys-spacing-6)', backgroundColor: 'var(--md-sys-color-surface-container-high)', border: 'none', borderRadius: 'var(--md-corner-small)', cursor: 'pointer' }}>`
🔵 **INFO:** Consider using M3Typography for text: "📤 Share"
`<button style={{ padding: 'var(--md-sys-spacing-3) var(--md-sys-spacing-6)', backgroundColor: 'var(--md-sys-color-surface-container-high)', border: 'none', borderRadius: 'var(--md-corner-small)', cursor: 'pointer' }}>`
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "Class 1A - Mathematics"
`<h1>Class 1A - Mathematics</h1>`
🔵 **INFO:** Consider using M3Typography for text: "24 Students"
`<p>24 Students</p>`
🔵 **INFO:** Consider using M3Typography for text: "👥 Roster"
`<button style={{ padding: 'var(--md-sys-spacing-2) var(--md-sys-spacing-4)', backgroundColor: 'var(--md-sys-color-surface-container-high)', border: 'none', borderRadius: 'var(--md-corner-small)', cursor: 'pointer' }}>`
🔵 **INFO:** Consider using M3Typography for text: "📊 Grades"
`<button style={{ padding: 'var(--md-sys-spacing-2) var(--md-sys-spacing-4)', backgroundColor: 'var(--md-sys-color-surface-container-high)', border: 'none', borderRadius: 'var(--md-corner-small)', cursor: 'pointer' }}>`
🔵 **INFO:** Consider using M3Typography for text: "📚 Materials"
`<button style={{ padding: 'var(--md-sys-spacing-2) var(--md-sys-spacing-4)', backgroundColor: 'var(--md-sys-color-surface-container-high)', border: 'none', borderRadius: 'var(--md-corner-small)', cursor: 'pointer' }}>`
🔵 **INFO:** Consider using M3Typography for text: "+"
`>`
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "Content View"
`<h1>Content View</h1>`
🔵 **INFO:** Consider using M3Typography for text: "➕ Create Document"
`>`
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "Accessible Bottom App Bar"
`<h1>Accessible Bottom App Bar</h1>`
🔵 **INFO:** Consider using M3Typography for text: "Content above the navigation bar"
...
🟡 **WARNING:** Legacy CSS class detected: sys-color
`borderTop: '1px solid var(--md-sys-color-outline-variant)',`
🟡 **WARNING:** Legacy CSS class detected: sys-elevation2
...
🟡 **WARNING:** Legacy CSS class detected: px-4
`medium: 'h-10 px-4 text-base gap-2',`
🟡 **WARNING:** Legacy CSS class detected: px-6
`large: 'h-12 px-6 text-lg gap-3'`
🟡 **WARNING:** Legacy CSS class detected: gap-2
`small: 'h-8 px-3 text-sm gap-2',`
🟡 **WARNING:** Legacy CSS class detected: gap-2
`medium: 'h-10 px-4 text-base gap-2',`
🟡 **WARNING:** Legacy CSS class detected: gap-3
`large: 'h-12 px-6 text-lg gap-3'`
🟡 **WARNING:** Legacy CSS class detected: rounded-md
...
🟡 **WARNING:** Legacy CSS class detected: sys-color
`text: 'bg-transparent text-[var(--md-sys-color-primary)] hover:bg-[var(--md-sys-color-primary-container)] focus:ring-[var(--md-sys-color-primary)]'`
🟡 **WARNING:** Legacy CSS class detected: opacity-50
`const baseClasses = 'inline-flex items-center justify-center rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none';`
...
🔵 **INFO:** Consider using M3Typography for text: "Card Title"
`<h3 style={{ marginTop: 0, marginBottom: '0.5rem' }}>Card Title</h3>`
🔵 **INFO:** Consider using M3Typography for text: "This card demonstrates the M3 Card component with richer content and multiple elements."
...
🟡 **WARNING:** Legacy CSS class detected: shadow-
`filled: 'bg-[var(--md-sys-color-surface-variant)] shadow-none border-none'`
🟡 **WARNING:** Legacy CSS class detected: p-0
`none: 'p-0',`
🟡 **WARNING:** Legacy CSS class detected: p-3
`small: 'p-3',`
🟡 **WARNING:** Legacy CSS class detected: p-4
`medium: 'p-4',`
🟡 **WARNING:** Legacy CSS class detected: p-6
`large: 'p-6'`
🟡 **WARNING:** Legacy CSS class detected: sys-color
...
🟡 **WARNING:** Legacy CSS class detected: sys-spacing
`<div style={{ display: 'flex', gap: 'var(--md-sys-spacing-2)', flexWrap: 'wrap' }}>`
🔵 **INFO:** Consider using M3Typography for text: "Chip deleted!"
...
🔵 **INFO:** Consider using M3Typography for text: "("
`{filters.map((filter) => (`
🔵 **INFO:** Consider using M3Typography for text: "Document Context Tags"
`<h4 style={{ margin: '0 0 var(--md-sys-spacing-4) 0' }}>Document Context Tags</h4>`
🔵 **INFO:** Consider using M3Typography for text: "("
`{filters.map((filter) => (`
🔵 **INFO:** Consider using M3Typography for text: "(['User1', 'User2']);

    const handleKeyDown = (e: React.KeyboardEvent"

`const [chips, setChips] = useState<string[]>(['User1', 'User2']);`
🔵 **INFO:** Consider using M3Typography for text: "Add Recipients (type and press Enter)"
`<label style={{ display: 'block', marginBottom: 'var(--md-sys-spacing-2)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)' }}>`
🔵 **INFO:** Consider using M3Typography for text: "("
`{filters.map((filter) => (`
🔵 **INFO:** Consider using M3Typography for text: "("
...
🟡 **WARNING:** Legacy CSS class detected: rounded-3xl
`className={`flex flex-col items-center justify-center p-8 md:p-8 rounded-3xl md:rounded-4xl border-2 transition-all gap-8 md:gap-8 min-w-[100px] md:min-w-[140px] group ${selected ? 'border-primary bg-primary-container text-on-primary-container shadow-2xl scale-[1.05]' : 'border-outline-variant/30 bg-surface-container/50 hover:border-outline hover:bg-surface-container-high'} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: rounded-4xl
`className={`flex flex-col items-center justify-center p-8 md:p-8 rounded-3xl md:rounded-4xl border-2 transition-all gap-8 md:gap-8 min-w-[100px] md:min-w-[140px] group ${selected ? 'border-primary bg-primary-container text-on-primary-container shadow-2xl scale-[1.05]' : 'border-outline-variant/30 bg-surface-container/50 hover:border-outline hover:bg-surface-container-high'} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: rounded-xl
`<div className={`w-10 h-10 md:w-16 md:h-16 rounded-xl flex items-center justify-center transition-all ${selected ? 'bg-primary text-on-primary shadow-lg' : 'bg-surface text-primary group-hover:scale-110'}`}>`
🔵 **INFO:** Consider using M3Typography for text: "("
...
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "DEFAULT"
`<h3 style={{ margin: '0 0 1rem 0', fontSize: 'var(--md-sys-typescale-body-small-size)', opacity: 0.6 }}>DEFAULT</h3>`
🔵 **INFO:** Consider using M3Typography for text: "WITH HELPER"
`<h3 style={{ margin: '0 0 1rem 0', fontSize: 'var(--md-sys-typescale-body-small-size)', opacity: 0.6 }}>WITH HELPER</h3>`
🔵 **INFO:** Consider using M3Typography for text: "ERROR STATE"
`<h3 style={{ margin: '0 0 1rem 0', fontSize: 'var(--md-sys-typescale-body-small-size)', opacity: 0.6 }}>ERROR STATE</h3>`
🔵 **INFO:** Consider using M3Typography for text: "DISABLED"
`<h3 style={{ margin: '0 0 1rem 0', fontSize: 'var(--md-sys-typescale-body-small-size)', opacity: 0.6 }}>DISABLED</h3>`
🔵 **INFO:** Inline style without MD3 tokens detected
...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: flex-end
...
🔵 **INFO:** Consider using M3Typography for text: "Open Dialog"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Open Dialog"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Cancel"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Confirm"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Open Dialog"
`>`
🔵 **INFO:** Consider using M3Typography for text: "This dialog takes up the full screen."
`<p>This dialog takes up the full screen.</p>`
🔵 **INFO:** Consider using M3Typography for text: "It's useful for complex forms or detailed content."
`<p>It's useful for complex forms or detailed content.</p>`
🔵 **INFO:** Consider using M3Typography for text: "Open Fullscreen"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Theme"
`<label style={{ display: 'block', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginBottom: '0.25rem' }}>`
🔵 **INFO:** Consider using M3Typography for text: "Light"
`<option>Light</option>`
🔵 **INFO:** Consider using M3Typography for text: "Dark"
`<option>Dark</option>`
🔵 **INFO:** Consider using M3Typography for text: "Auto"
`<option>Auto</option>`
🔵 **INFO:** Consider using M3Typography for text: "Enable notifications"
`<input type="checkbox" defaultChecked />`
🔵 **INFO:** Consider using M3Typography for text: "),
buttons: ("
`</div>`
🔵 **INFO:** Consider using M3Typography for text: "Save Settings"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Open Settings"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Open Small Dialog"
`>`
🔵 **INFO:** Inline style without MD3 tokens detected
`style={{`
🔵 **INFO:** Inline style without MD3 tokens detected
...
🟡 **WARNING:** Legacy CSS class detected: p-8
`className={`dialog-shell fixed inset-0 flex items-center justify-center p-8 pointer-events-auto ${`🟡 **WARNING:** Legacy CSS class detected: p-0
  `mode === 'fullscreen' ? '!p-0 md:!p-8' : ''`🟡 **WARNING:** Legacy CSS class detected: p-8
  `mode === 'fullscreen' ? '!p-0 md:!p-8' : ''`🟡 **WARNING:** Legacy CSS class detected: p-8
  `<div className="flex-1 overflow-y-auto custom-scrollbar p-8 md:p-6">`🟡 **WARNING:** Legacy CSS class detected: p-6
  `<div className="flex-1 overflow-y-auto custom-scrollbar p-8 md:p-6">`🟡 **WARNING:** Legacy CSS class detected: px-4
  `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-[var(--md-sys-color-outline-variant)]/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-[var(--md-sys-color-surface-container-highest)]/10 to-transparent">`🟡 **WARNING:** Legacy CSS class detected: px-6
  `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-[var(--md-sys-color-outline-variant)]/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-[var(--md-sys-color-surface-container-highest)]/10 to-transparent">`🟡 **WARNING:** Legacy CSS class detected: px-4
  `<div className="px-4 md:px-6 py-4 border-t border-[var(--md-sys-color-outline-variant)]/10 bg-[var(--md-sys-color-surface-container-low)]/50 flex justify-end items-center gap-6 shrink-0">`🟡 **WARNING:** Legacy CSS class detected: px-6
  `<div className="px-4 md:px-6 py-4 border-t border-[var(--md-sys-color-outline-variant)]/10 bg-[var(--md-sys-color-surface-container-low)]/50 flex justify-end items-center gap-6 shrink-0">`🟡 **WARNING:** Legacy CSS class detected: py-4
  `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-[var(--md-sys-color-outline-variant)]/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-[var(--md-sys-color-surface-container-highest)]/10 to-transparent">`🟡 **WARNING:** Legacy CSS class detected: py-6
  `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-[var(--md-sys-color-outline-variant)]/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-[var(--md-sys-color-surface-container-highest)]/10 to-transparent">`🟡 **WARNING:** Legacy CSS class detected: py-4
  `<div className="px-4 md:px-6 py-4 border-t border-[var(--md-sys-color-outline-variant)]/10 bg-[var(--md-sys-color-surface-container-low)]/50 flex justify-end items-center gap-6 shrink-0">`🟡 **WARNING:** Legacy CSS class detected: py-4
  `<p className="text-[var(--md-sys-typescale-body-large)] font-[var(--md-sys-typescale-body-large-font)] text-[var(--md-sys-color-on-surface)] py-4">{message}</p>`🟡 **WARNING:** Legacy CSS class detected: mx-4
  `mx-4`🟡 **WARNING:** Legacy CSS class detected: gap-6
  `<div className="px-4 md:px-6 py-4 border-t border-[var(--md-sys-color-outline-variant)]/10 bg-[var(--md-sys-color-surface-container-low)]/50 flex justify-end items-center gap-6 shrink-0">`🟡 **WARNING:** Legacy CSS class detected: gap-6
  `}) => <footer className={`m3-dialog-actions flex justify-end gap-6 ${className}`}>{children}</footer>;`🟡 **WARNING:** Legacy CSS class detected: flex-col
  `flex flex-col`🟡 **WARNING:** Legacy CSS class detected: flex-grow
  `<div className="flex-grow min-w-0">`🟡 **WARNING:** Legacy CSS class detected: glass-blur
  `style={{ backdropFilter: `blur(var(--sys-glass-blur))` }}`🟡 **WARNING:** Legacy CSS class detected: sys-glass
  `style={{ backdropFilter: `blur(var(--sys-glass-blur))` }}`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `bg-[var(--md-sys-color-surface-container-high)]`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `border border-[var(--md-sys-color-outline-variant)]/20`🟡 **WARNING:** Legacy CSS class detected: sys-elevation
  `shadow-[var(--md-sys-elevation-level4)]`🟡 **WARNING:** Legacy CSS class detected: sys-shape
  `? 'w-full h-full md:h-[90vh] md:max-w-5xl md:rounded-[var(--md-sys-shape-corner-extra-large)] rounded-[var(--md-sys-shape-corner-large)]'`🟡 **WARNING:** Legacy CSS class detected: sys-shape
  `? 'w-full h-full md:h-[90vh] md:max-w-5xl md:rounded-[var(--md-sys-shape-corner-extra-large)] rounded-[var(--md-sys-shape-corner-large)]'`🟡 **WARNING:** Legacy CSS class detected: sys-shape
...
🟡 **WARNING:** Legacy CSS class detected: sys-shape
   `: `w-full ${maxWidthMap[maxWidth]} max-h-[90vh] rounded-[var(--md-sys-shape-corner-large)] md:rounded-[var(--md-sys-shape-corner-extra-large)]``
🟡 **WARNING:** Legacy CSS class detected: sys-color
   `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-[var(--md-sys-color-outline-variant)]/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-[var(--md-sys-color-surface-container-highest)]/10 to-transparent">`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-[var(--md-sys-color-outline-variant)]/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-[var(--md-sys-color-surface-container-highest)]/10 to-transparent">`🟡 **WARNING:** Legacy CSS class detected: sys-typescale
  `className="text-[var(--md-sys-typescale-headline-small)] font-[var(--md-sys-typescale-headline-small-font)] font-black text-[var(--md-sys-color-on-surface)] tracking-tight"`🟡 **WARNING:** Legacy CSS class detected: sys-typescale
  `className="text-[var(--md-sys-typescale-headline-small)] font-[var(--md-sys-typescale-headline-small-font)] font-black text-[var(--md-sys-color-on-surface)] tracking-tight"`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `className="text-[var(--md-sys-typescale-headline-small)] font-[var(--md-sys-typescale-headline-small-font)] font-black text-[var(--md-sys-color-on-surface)] tracking-tight"`🟡 **WARNING:** Legacy CSS class detected: sys-typescale
  `<p className="text-[var(--md-sys-typescale-body-medium)] font-[var(--md-sys-typescale-body-medium-font)] text-[var(--md-sys-color-on-surface-variant)] opacity-80 line-clamp-2 mt-4 leading-snug">`🟡 **WARNING:** Legacy CSS class detected: sys-typescale
  `<p className="text-[var(--md-sys-typescale-body-medium)] font-[var(--md-sys-typescale-body-medium-font)] text-[var(--md-sys-color-on-surface-variant)] opacity-80 line-clamp-2 mt-4 leading-snug">`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `<p className="text-[var(--md-sys-typescale-body-medium)] font-[var(--md-sys-typescale-body-medium-font)] text-[var(--md-sys-color-on-surface-variant)] opacity-80 line-clamp-2 mt-4 leading-snug">`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `className="w-10 h-10 rounded-full hover:bg-[var(--md-sys-color-surface-container-highest)] flex items-center justify-center transition-colors ml-4"`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `<div className="px-4 md:px-6 py-4 border-t border-[var(--md-sys-color-outline-variant)]/10 bg-[var(--md-sys-color-surface-container-low)]/50 flex justify-end items-center gap-6 shrink-0">`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `<div className="px-4 md:px-6 py-4 border-t border-[var(--md-sys-color-outline-variant)]/10 bg-[var(--md-sys-color-surface-container-low)]/50 flex justify-end items-center gap-6 shrink-0">`🟡 **WARNING:** Legacy CSS class detected: sys-typescale
  `<p className="text-[var(--md-sys-typescale-body-large)] font-[var(--md-sys-typescale-body-large-font)] text-[var(--md-sys-color-on-surface)] py-4">{message}</p>`🟡 **WARNING:** Legacy CSS class detected: sys-typescale
  `<p className="text-[var(--md-sys-typescale-body-large)] font-[var(--md-sys-typescale-body-large-font)] text-[var(--md-sys-color-on-surface)] py-4">{message}</p>`🟡 **WARNING:** Legacy CSS class detected: sys-color
  `<p className="text-[var(--md-sys-typescale-body-large)] font-[var(--md-sys-typescale-body-large-font)] text-[var(--md-sys-color-on-surface)] py-4">{message}</p>`🟡 **WARNING:** Legacy CSS class detected: opacity-80
  `<p className="text-[var(--md-sys-typescale-body-medium)] font-[var(--md-sys-typescale-body-medium-font)] text-[var(--md-sys-color-on-surface-variant)] opacity-80 line-clamp-2 mt-4 leading-snug">`🔵 **INFO:** Consider using M3Typography for text: "close"
  `<span className="material-symbols-outlined">close</span>`
🔵 **INFO:** Consider using M3Typography for text: ";
...
- M3DialogActions - Actions/footer wrapper component
  \*/
  export const M3DialogActions: React.FC"
...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: bg-
`<div className={`bg-surface-variant/80 p-5 rounded-3xl border border-outline-variant/30 flex flex-col items-center justify-center text-center min-h-full ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: text-
`<div className={`bg-surface-variant/80 p-5 rounded-3xl border border-outline-variant/30 flex flex-col items-center justify-center text-center min-h-full ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: border-
`<div className={`bg-surface-variant/80 p-5 rounded-3xl border border-outline-variant/30 flex flex-col items-center justify-center text-center min-h-full ${className}`}>`
...
🔵 **INFO:** Consider using M3Typography for text: "Additional content can be added via children prop"
`<p>Additional content can be added via children prop</p>`
🔵 **INFO:** Consider using M3Typography for text: "This allows for more complex card layouts"
...
🟡 **WARNING:** Legacy CSS class detected: p-8
`className={`p-8 md:p-12 transition-all duration-300 flex flex-col min-h-[160px] md:min-h-[180px] ${isClickable ? 'cursor-pointer hover:shadow-xl hover:shadow-black/10 hover:border-white/30 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2' : ''} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: p-12
`className={`p-8 md:p-12 transition-all duration-300 flex flex-col min-h-[160px] md:min-h-[180px] ${isClickable ? 'cursor-pointer hover:shadow-xl hover:shadow-black/10 hover:border-white/30 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2' : ''} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: flex-col
`className={`p-8 md:p-12 transition-all duration-300 flex flex-col min-h-[160px] md:min-h-[180px] ${isClickable ? 'cursor-pointer hover:shadow-xl hover:shadow-black/10 hover:border-white/30 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2' : ''} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: flex-grow
`<div className="flex-grow relative z-10 space-y-3">`
🟡 **WARNING:** Legacy CSS class detected: rounded-t
...
🟡 **WARNING:** Legacy CSS class detected: opacity-20
...
🟡 **WARNING:** Legacy CSS class detected: opacity-70
`<span className="material-symbols-outlined opacity-50 m3-icon-md transition-opacity group-hover:opacity-70">arrow_forward</span>`
🟡 **WARNING:** Legacy CSS class detected: opacity-80
`<p className="m3-body-large opacity-80 leading-relaxed font-medium line-clamp-3">{description}</p>`
🔵 **INFO:** Consider using M3Typography for text: "arrow_forward"
`<span className="material-symbols-outlined opacity-50 m3-icon-md transition-opacity group-hover:opacity-70">arrow_forward</span>`
🔵 **INFO:** Inline style without MD3 tokens detected
...
🔵 **INFO:** Consider using M3Typography for text: "✓"
`>`
🔵 **INFO:** Consider using M3Typography for text: "3"
`>`
🔵 **INFO:** Consider using M3Typography for text: "📌"
`<span style={{ fontSize: 'var(--md-sys-typescale-body-medium-size)' }}>📌</span>`
🔵 **INFO:** Consider using M3Typography for text: "),
...
🟡 **WARNING:** Legacy CSS class detected: gap-4
`className={`flex items-start gap-4 p-4 rounded-xl transition-all min-h-[56px] ${isClickable ? 'cursor-pointer hover:bg-surface-container-highest focus-visible:bg-surface-container-highest active:bg-surface-container-highest' : ''} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: gap-0
...
🟡 **WARNING:** Legacy CSS class detected: sys-spacing
`<div style={{ padding: 'var(--md-sys-spacing-8)' }}>`
🔵 **INFO:** Consider using M3Typography for text: "Open Menu"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Event Menu"
`>`
🔵 **INFO:** Consider using M3Typography for text: "File Menu"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Edit Menu"
`>`
🔵 **INFO:** Consider using M3Typography for text: "⋯ Azioni"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Select Class"
`>`
🔵 **INFO:** Inline style without MD3 tokens detected
`<div style={{ padding: 'var(--md-sys-spacing-8)' }}>`
...
🟡 **WARNING:** Legacy CSS class detected: sys-color
`e.currentTarget.style.background = 'var(--md-sys-color-surface-container-high)';`
🔵 **INFO:** Consider using M3Typography for text: "(null);

    return ("

`const [anchorEl, setAnchorEl] = useState<HTMLElement | null>(null);`
🔵 **INFO:** Consider using M3Typography for text: "Open Popover"
`>`
🔵 **INFO:** Consider using M3Typography for text: "This is a basic popover with some content."
`<p style={{ margin: `0 0 var(--md-sys-spacing-3) 0`, color: 'var(--md-sys-color-on-surface)' }}>`
🔵 **INFO:** Consider using M3Typography for text: "Click outside to close."
`<p style={{ margin: '0', color: 'var(--md-sys-color-on-surface-variant)', fontSize: 'var(--md-sys-typescale-body-small-size)' }}>`
🔵 **INFO:** Consider using M3Typography for text: "(null);
...
`const [anchorEl, setAnchorEl] = useState<HTMLElement | null>(null);`
🔵 **INFO:** Consider using M3Typography for text: "Event Actions"
`>`
🔵 **INFO:** Consider using M3Typography for text: "📝 Modifica"
`>`
🔵 **INFO:** Consider using M3Typography for text: "🗑️ Elimina"
`>`
🔵 **INFO:** Consider using M3Typography for text: "(null);
...
`const [anchorEl, setAnchorEl] = useState<HTMLElement | null>(null);`
🔵 **INFO:** Consider using M3Typography for text: "Popover Above"
`>`
🔵 **INFO:** Consider using M3Typography for text: "This popover appears above the trigger button."
`<p style={{ margin: '0', color: 'var(--md-sys-color-on-surface)' }}>`
🔵 **INFO:** Consider using M3Typography for text: "Long List"
`>`
🔵 **INFO:** Consider using M3Typography for text: "("
`{items.map((item) => (`
🔵 **INFO:** Consider using M3Typography for text: "(null);
...
`const [anchorEl, setAnchorEl] = useState<HTMLElement | null>(null);`
🔵 **INFO:** Consider using M3Typography for text: "Quick Menu"
`>`
🔵 **INFO:** Consider using M3Typography for text: "("
`{items.map((item) => (`
🔵 **INFO:** Inline style without MD3 tokens detected
...
**Issues:**
🔵 **INFO:** Consider using M3Typography for text: "Content"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Test Content"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Content"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Content"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Anchor"
`<button>Anchor</button>`
🔵 **INFO:** Consider using M3Typography for text: "Content"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Content"
`>`
🔵 **INFO:** Consider using M3Typography for text: "Inner Button"
...
🟡 **WARNING:** Legacy CSS class detected: sys-color
`className="m3-popover__backdrop fixed inset-0 bg-[var(--md-sys-color-scrim)] opacity-[var(--md-sys-state-opacity-scrim)] cursor-pointer"`
🟡 **WARNING:** Legacy CSS class detected: sys-state
`className="m3-popover__backdrop fixed inset-0 bg-[var(--md-sys-color-scrim)] opacity-[var(--md-sys-state-opacity-scrim)] cursor-pointer"`
🟡 **WARNING:** Legacy CSS class detected: sys-color
`className={`m3-popover fixed bg-[var(--md-sys-color-surface-container)] border border-[var(--md-sys-color-outline-variant)] rounded-[var(--md-sys-shape-corner-large)] shadow-[var(--md-sys-elevation-level2)] ${className || ''}`.trim()}`
🟡 **WARNING:** Legacy CSS class detected: sys-color
`className={`m3-popover fixed bg-[var(--md-sys-color-surface-container)] border border-[var(--md-sys-color-outline-variant)] rounded-[var(--md-sys-shape-corner-large)] shadow-[var(--md-sys-elevation-level2)] ${className || ''}`.trim()}`
🟡 **WARNING:** Legacy CSS class detected: sys-shape
`className={`m3-popover fixed bg-[var(--md-sys-color-surface-container)] border border-[var(--md-sys-color-outline-variant)] rounded-[var(--md-sys-shape-corner-large)] shadow-[var(--md-sys-elevation-level2)] ${className || ''}`.trim()}`
...
🟡 **WARNING:** Legacy CSS class detected: sys-spacing
`<div className="m3-popover__content p-[var(--md-sys-spacing-4)] overflow-y-auto" style={{ maxHeight: 'min(25rem, 70vh)' }}>`
🟡 **WARNING:** Legacy CSS class detected: sys-color
...
🔵 **INFO:** Consider using M3Typography for text: "_"
`_ >`🔵 **INFO:** Consider using M3Typography for text: "Edit"
  `_ <button onClick={handleEdit}>Edit</button>`
🔵 **INFO:** Consider using M3Typography for text: "_"
`* >`
🔵 **INFO:** Consider using M3Typography for text: "Delete"
`*   <button onClick={handleDelete}>Delete</button>`
🔵 **INFO:** Consider using M3Typography for text: "_"
`_ <button onClick={handleDelete}>Delete</button>`🔵 **INFO:** Inline style without MD3 tokens detected
  `style={{ zIndex: zIndex - 1 }}`🔵 **INFO:** Inline style without MD3 tokens detected
  `style={{`
🔵 **INFO:** Inline style without MD3 tokens detected
   `<div className="m3-popover__subtitle font-body-small text-[var(--md-sys-color-on-surface-variant)]" style={{ lineHeight: '16px', margin: 0 }}>`🔵 **INFO:** Inline style without MD3 tokens detected
  `<div className="m3-popover\_\_content p-[var(--md-sys-spacing-4)] overflow-y-auto" style={{ maxHeight: 'min(25rem, 70vh)' }}>`
...
🔵 **INFO:** Consider using M3Typography for text: "Current rating:"
`<p style={{ marginTop: '1rem', fontSize: 'var(--md-sys-typescale-body-medium-size)', color: 'var(--sys-on-surface-variant)' }}>`
🔵 **INFO:** Inline style without MD3 tokens detected
`<p style={{ marginTop: '1rem', fontSize: 'var(--md-sys-typescale-body-medium-size)', color: 'var(--sys-on-surface-variant)' }}>`
...
🟡 **WARNING:** Legacy CSS class detected: px-6
`className="m3-expansion-summary !px-6 !py-5 hover:bg-surface-container-high/80 cursor-pointer list-none flex justify-between items-center"`
🟡 **WARNING:** Legacy CSS class detected: px-8
`<div className="m3-expansion-content !px-8 !pb-8 space-y-6 pt-2">{children}</div>`
🟡 **WARNING:** Legacy CSS class detected: py-5
`className="m3-expansion-summary !px-6 !py-5 hover:bg-surface-container-high/80 cursor-pointer list-none flex justify-between items-center"`
🟡 **WARNING:** Legacy CSS class detected: gap-5
...
🔵 **INFO:** Consider using M3Typography for text: "("
`}) => (`
🔵 **INFO:** Consider using M3Typography for text: "expand_more"
...
🟡 **WARNING:** Legacy CSS class detected: shadow-
`className="w-20 h-20 rounded-2xl bg-surface-container text-3xl font-extrabold border-2 border-outline-variant/30 hover:border-primary hover:bg-surface hover:shadow-xl active:scale-90 transition-all"`
🟡 **WARNING:** Legacy CSS class detected: gap-6
...
🔵 **INFO:** Consider using M3Typography for text: "backspace"
`<span className="material-symbols-outlined text-3xl font-light">backspace</span>`
🔵 **INFO:** Consider using M3Typography for text: ");
return ("
`</button>`
...
🔵 **INFO:** Consider using M3Typography for text: "-- Select --"
`<option value="">-- Select --</option>`
🔵 **INFO:** Consider using M3Typography for text: "Option 1"
`<option value="option1">Option 1</option>`
🔵 **INFO:** Consider using M3Typography for text: "Option 2"
`<option value="option2">Option 2</option>`
🔵 **INFO:** Consider using M3Typography for text: "Option 3"
`<option value="option3">Option 3</option>`
🔵 **INFO:** Consider using M3Typography for text: "Select a country"
`<option value="">Select a country</option>`
🔵 **INFO:** Consider using M3Typography for text: "United States"
`<option value="us">United States</option>`
🔵 **INFO:** Consider using M3Typography for text: "United Kingdom"
`<option value="uk">United Kingdom</option>`
🔵 **INFO:** Consider using M3Typography for text: "Canada"
`<option value="ca">Canada</option>`
🔵 **INFO:** Consider using M3Typography for text: "Australia"
`<option value="au">Australia</option>`
🔵 **INFO:** Consider using M3Typography for text: "Germany"
`<option value="de">Germany</option>`
🔵 **INFO:** Consider using M3Typography for text: "France"
`<option value="fr">France</option>`
🔵 **INFO:** Consider using M3Typography for text: "Italy"
`<option value="it">Italy</option>`
🔵 **INFO:** Consider using M3Typography for text: "-- Select Category --"
`<option value="">-- Select Category --</option>`
🔵 **INFO:** Consider using M3Typography for text: "Technology"
`<option value="tech">Technology</option>`
🔵 **INFO:** Consider using M3Typography for text: "Health"
`<option value="health">Health</option>`
🔵 **INFO:** Consider using M3Typography for text: "Finance"
`<option value="finance">Finance</option>`
🔵 **INFO:** Consider using M3Typography for text: "Low"
`<option value="low">Low</option>`
🔵 **INFO:** Consider using M3Typography for text: "Medium"
`<option value="medium">Medium</option>`
🔵 **INFO:** Consider using M3Typography for text: "High"
`<option value="high">High</option>`
🔵 **INFO:** Consider using M3Typography for text: "Urgent"
`<option value="urgent">Urgent</option>`
🔵 **INFO:** Consider using M3Typography for text: "Cannot select"
`<option value="">Cannot select</option>`
🔵 **INFO:** Consider using M3Typography for text: "Option 1"
`<option value="option1">Option 1</option>`
🔵 **INFO:** Consider using M3Typography for text: "Option 2"
`<option value="option2">Option 2</option>`
🔵 **INFO:** Consider using M3Typography for text: "-- Required --"
`<option value="">-- Required --</option>`
🔵 **INFO:** Consider using M3Typography for text: "Yes"
`<option value="yes">Yes</option>`
🔵 **INFO:** Consider using M3Typography for text: "No"
`<option value="no">No</option>`
🔵 **INFO:** Consider using M3Typography for text: "Select an option"
`<option value="">Select an option</option>`
🔵 **INFO:** Consider using M3Typography for text: "This select spans full width"
`<option value="1">This select spans full width</option>`
🔵 **INFO:** Consider using M3Typography for text: "Option 2"
`<option value="option2">Option 2</option>`
🔵 **INFO:** Consider using M3Typography for text: "Option 3"
`<option value="option3">Option 3</option>`
🔵 **INFO:** Consider using M3Typography for text: "Select language"
`<option value="">Select language</option>`
🔵 **INFO:** Consider using M3Typography for text: "English"
`<option value="en">English</option>`
🔵 **INFO:** Consider using M3Typography for text: "Español"
`<option value="es">Español</option>`
🔵 **INFO:** Consider using M3Typography for text: "Français"
`<option value="fr">Français</option>`
🔵 **INFO:** Consider using M3Typography for text: "Deutsch"
`<option value="de">Deutsch</option>`
🔵 **INFO:** Consider using M3Typography for text: "Italiano"
`<option value="it">Italiano</option>`
🔵 **INFO:** Consider using M3Typography for text: "Português"
`<option value="pt">Português</option>`
🔵 **INFO:** Consider using M3Typography for text: "中文"
`<option value="zh">中文</option>`
🔵 **INFO:** Consider using M3Typography for text: "日本語"
`<option value="ja">日本語</option>`
🔵 **INFO:** Consider using M3Typography for text: "Select time zone"
`<option value="">Select time zone</option>`
🔵 **INFO:** Consider using M3Typography for text: "UTC-8 (Pacific)"
`<option value="utc-8">UTC-8 (Pacific)</option>`
🔵 **INFO:** Consider using M3Typography for text: "UTC-7 (Mountain)"
`<option value="utc-7">UTC-7 (Mountain)</option>`
🔵 **INFO:** Consider using M3Typography for text: "UTC-6 (Central)"
`<option value="utc-6">UTC-6 (Central)</option>`
🔵 **INFO:** Consider using M3Typography for text: "UTC-5 (Eastern)"
`<option value="utc-5">UTC-5 (Eastern)</option>`
🔵 **INFO:** Consider using M3Typography for text: "UTC (GMT)"
`<option value="utc">UTC (GMT)</option>`
🔵 **INFO:** Consider using M3Typography for text: "UTC+1 (CET)"
`<option value="utc+1">UTC+1 (CET)</option>`
🔵 **INFO:** Consider using M3Typography for text: "UTC+9 (JST)"
`<option value="utc+9">UTC+9 (JST)</option>`
🔵 **INFO:** Consider using M3Typography for text: "Select year"
`<option value="">Select year</option>`
🔵 **INFO:** Consider using M3Typography for text: "("
`{Array.from({ length: 50 }, (_, i) => 2024 - i).map((year) => (`
🔵 **INFO:** Consider using M3Typography for text: "Select document type"
`<option value="">Select document type</option>`
🔵 **INFO:** Consider using M3Typography for text: "Thesis"
`<option value="thesis">Thesis</option>`
🔵 **INFO:** Consider using M3Typography for text: "Essay"
`<option value="essay">Essay</option>`
🔵 **INFO:** Consider using M3Typography for text: "Research Paper"
`<option value="research">Research Paper</option>`
🔵 **INFO:** Consider using M3Typography for text: "Report"
`<option value="report">Report</option>`
🔵 **INFO:** Consider using M3Typography for text: "Proposal"
`<option value="proposal">Proposal</option>`
🔵 **INFO:** Consider using M3Typography for text: "Contract"
`<option value="contract">Contract</option>`
🔵 **INFO:** Consider using M3Typography for text: "Letter"
`<option value="letter">Letter</option>`
🔵 **INFO:** Consider using M3Typography for text: "Resume"
`<option value="resume">Resume</option>`
🔵 **INFO:** Consider using M3Typography for text: "Note"
...
🔵 **INFO:** Consider using M3Typography for text: "expand_more"
`<span className="material-symbols-outlined absolute right-[var(--md-sys-spacing-6)] top-1/2 -translate-y-1/2 pointer-events-none opacity-[var(--md-sys-state-opacity-disabled)] group-focus-within:text-[var(--md-sys-color-primary)] group-focus-within:opacity-100 transition-all">`
🔵 **INFO:** Consider using M3Typography for text: "error"
`<span className="material-symbols-outlined text-[var(--md-sys-color-error)] ml-[var(--md-sys-spacing-2)] absolute left-[var(--md-sys-spacing-2)] top-1/2 -translate-y-1/2" aria-hidden="true">error</span>`
🔵 **INFO:** Consider using M3Typography for text: "error"
`<span className="material-symbols-outlined text-[var(--md-sys-color-error)] ml-[var(--md-sys-spacing-2)] absolute left-[var(--md-sys-spacing-2)] top-1/2 -translate-y-1/2" aria-hidden="true">error</span>`
...
🟡 **WARNING:** Legacy CSS class detected: gap-3
`<div className={`flex items-center gap-3 p-4 rounded-xl bg-surface-container-low/50 border border-outline-variant/30 ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: gap-1
`<div className="flex gap-1">`
🟡 **WARNING:** Legacy CSS class detected: rounded-xl
`<div className={`flex items-center gap-3 p-4 rounded-xl bg-surface-container-low/50 border border-outline-variant/30 ${className}`}>`
🔵 **INFO:** Consider using M3Typography for text: "smart_toy"
`<span className="material-symbols-outlined text-primary text-sm">smart_toy</span>`
🔵 **INFO:** Inline style without MD3 tokens detected
`<div className="w-2 h-2 bg-primary rounded-full animate-pulse" style={{ animationDelay: '0ms' }}></div>`
🔵 **INFO:** Inline style without MD3 tokens detected
...
🔵 **INFO:** Consider using M3Typography for text: "("
`render: () => (`
🔵 **INFO:** Consider using M3Typography for text: "clear classroom norms"
`'Establish <strong>clear classroom norms</strong> together with students',`
🔵 **INFO:** Consider using M3Typography for text: "together with students',
'Use"
`'Establish <strong>clear classroom norms</strong> together with students',`
🔵 **INFO:** Consider using M3Typography for text: "universal design for learning"
`'Use <em>universal design for learning</em> (UDL) principles',`
🔵 **INFO:** Consider using M3Typography for text: "(UDL) principles',
'Provide multiple means of"
`'Use <em>universal design for learning</em> (UDL) principles',`
🔵 **INFO:** Consider using M3Typography for text: "representation, action, and engagement"
...
`<span className="w-6 h-6 rounded-full bg-surface-container-highest flex items-center justify-center text-[10px] font-black flex-shrink-0 mt-0.5 group-hover:bg-primary group-hover:text-on-primary transition-colors">{i + 1}</span>`
🟡 **WARNING:** Legacy CSS class detected: bg-
`<div className="mt-8 flex gap-8 p-8 bg-secondary-container/30 rounded-xl text-sm border border-secondary/10">`
🟡 **WARNING:** Legacy CSS class detected: text-
`<div className="w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center text-primary">`
🟡 **WARNING:** Legacy CSS class detected: text-
...
🔵 **INFO:** Consider using M3Typography for text: "lightbulb"
`<span className="material-symbols-outlined text-lg">lightbulb</span>`
🔵 **INFO:** Consider using M3Typography for text: "Scenario"
`<p className="m3-label-small text-primary uppercase font-black tracking-[0.2em] opacity-70">Scenario</p>`
🔵 **INFO:** Consider using M3Typography for text: "("
`{steps.map((step, i) => (`
🔵 **INFO:** Consider using M3Typography for text: "tips_and_updates"
`<span className="material-symbols-outlined text-secondary font-black">tips_and_updates</span>`
