...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: bg-gradient
...
🟡 **WARNING:** Legacy CSS class detected: sys-color
   `color: 'var(--md-sys-color-on-surface-variant)',`
🔵 **INFO:** Consider using M3Typography for text: "chevron_right"
   `>`
🔵 **INFO:** Inline style without MD3 tokens detected
...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: bg-tertiary
...
🟡 **WARNING:** Legacy CSS class detected: items-center
   `className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🟡 **WARNING:** Legacy CSS class detected: rounded-full
   `className="flex items-center gap-2 px-3 py-1.5 min-h-[32px] opacity-60 hover:opacity-100 transition-opacity select-none cursor-help bg-tertiary-container/20 rounded-full border border-tertiary/10"`
🔵 **INFO:** Consider using M3Typography for text: "("
...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: text-primary
...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: bg-primary
...
🟡 **WARNING:** Legacy CSS class detected: text-lg
   `lg: 'w-16 h-16 text-lg',`
🟡 **WARNING:** Legacy CSS class detected: text-2xl
   `xl: 'w-24 h-24 text-2xl'`
🟡 **WARNING:** Legacy CSS class detected: text-on
   `<div className={`relative flex-shrink-0 rounded-3xl overflow-hidden bg-primary-container text-on-primary-container flex items-center justify-center font-black ${sizeClasses[size]} ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: flex-shrink
   `<div className={`relative flex-shrink-0 rounded-3xl overflow-hidden bg-primary-container text-on-primary-container flex items-center justify-center font-black ${sizeClasses[size]} ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: justify-center
   `<div className={`relative flex-shrink-0 rounded-3xl overflow-hidden bg-primary-container text-on-primary-container flex items-center justify-center font-black ${sizeClasses[size]} ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: items-center
...
🟡 **WARNING:** Legacy CSS class detected: bg-surface
   `className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: bg-surface
   `className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: text-3xl
   `<span className="material-symbols-outlined text-3xl">{icon}</span>`
🟡 **WARNING:** Legacy CSS class detected: text-sm
   `<span className="text-sm font-black text-center tracking-tight">{label}</span>`
🟡 **WARNING:** Legacy CSS class detected: text-center
   `<span className="text-sm font-black text-center tracking-tight">{label}</span>`
🟡 **WARNING:** Legacy CSS class detected: text-on
...
🟡 **WARNING:** Legacy CSS class detected: text-center
   `{description && <p className="text-[10px] text-on-surface-variant text-center opacity-60 leading-tight font-medium line-clamp-2 px-4">{description}</p>}`
🟡 **WARNING:** Legacy CSS class detected: border-2
   `className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: border-primary
   `className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: border-outline
   `className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: border-outline
   `className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
🟡 **WARNING:** Legacy CSS class detected: shadow-xl
   `className={`flex flex-col items-center gap-8 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}`
...
🟡 **WARNING:** Legacy CSS class detected: text-on
   `<div className="w-24 h-24 rounded-full bg-surface-container-high flex items-center justify-center mb-8 text-on-surface-variant/30 shadow-inner">`
🟡 **WARNING:** Legacy CSS class detected: text-6xl
...
🟡 **WARNING:** Legacy CSS class detected: border-2
   `<div className="flex flex-col items-center justify-center p-16 text-center bg-surface-container-low/50 backdrop-blur-sm rounded-5xl border-2 border-dashed border-outline-variant/30">`
🟡 **WARNING:** Legacy CSS class detected: border-dashed
   `<div className="flex flex-col items-center justify-center p-16 text-center bg-surface-container-low/50 backdrop-blur-sm rounded-5xl border-2 border-dashed border-outline-variant/30">`
🟡 **WARNING:** Legacy CSS class detected: border-outline
   `<div className="flex flex-col items-center justify-center p-16 text-center bg-surface-container-low/50 backdrop-blur-sm rounded-5xl border-2 border-dashed border-outline-variant/30">`
🟡 **WARNING:** Legacy CSS class detected: shadow-inner
   `<div className="w-24 h-24 rounded-full bg-surface-container-high flex items-center justify-center mb-8 text-on-surface-variant/30 shadow-inner">`
...
🟡 **WARNING:** Legacy CSS class detected: text-4xl
...
🟡 **WARNING:** Legacy CSS class detected: bg-secondary
...
🟡 **WARNING:** Legacy CSS class detected: bg-error
...
🟡 **WARNING:** Legacy CSS class detected: bg-white
...
🟡 **WARNING:** Legacy CSS class detected: bg-black
   `<div className="p-5 rounded-2xl bg-white/30 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-inner border border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">`
🟡 **WARNING:** Legacy CSS class detected: bg-black
...
🟡 **WARNING:** Legacy CSS class detected: border-primary
   `primary: 'bg-primary-container/80 text-on-primary-container border-primary/10',`
🟡 **WARNING:** Legacy CSS class detected: border-secondary
   `secondary: 'bg-secondary-container/80 text-on-secondary-container border-secondary/10',`
🟡 **WARNING:** Legacy CSS class detected: border-tertiary
   `tertiary: 'bg-tertiary-container/80 text-on-tertiary-container border-tertiary/10',`
🟡 **WARNING:** Legacy CSS class detected: border-error
   `error: 'bg-error-container/80 text-on-error-container border-error/10',`
🟡 **WARNING:** Legacy CSS class detected: border-outline
   `surface: 'bg-surface-container/80 text-on-surface border-outline-variant/10',`
🟡 **WARNING:** Legacy CSS class detected: border-outline
...
🟡 **WARNING:** Legacy CSS class detected: border-secondary
   `tonal: 'bg-secondary-container/50 text-on-secondary-container border-secondary/10'`
🟡 **WARNING:** Legacy CSS class detected: border-white
...
🟡 **WARNING:** Legacy CSS class detected: border-black
   `className={`m3-info-card p-6 md:p-10 shadow-xl md:shadow-2xl backdrop-blur-2xl border border-white/10 dark:border-black/10 overflow-hidden relative group transition-all duration-500 hover:shadow-primary/10 ${onClick ? 'cursor-pointer hover:scale-[1.02] active:scale-[0.98]' : ''} ${variantClasses} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: border-white
   `<div className="p-5 rounded-2xl bg-white/30 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-inner border border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">`
🟡 **WARNING:** Legacy CSS class detected: shadow-lg
   `elevated: 'bg-surface-container-low shadow-lg border-outline-variant/10',`
🟡 **WARNING:** Legacy CSS class detected: shadow-xl
   `className={`m3-info-card p-6 md:p-10 shadow-xl md:shadow-2xl backdrop-blur-2xl border border-white/10 dark:border-black/10 overflow-hidden relative group transition-all duration-500 hover:shadow-primary/10 ${onClick ? 'cursor-pointer hover:scale-[1.02] active:scale-[0.98]' : ''} ${variantClasses} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: shadow-2xl
   `className={`m3-info-card p-6 md:p-10 shadow-xl md:shadow-2xl backdrop-blur-2xl border border-white/10 dark:border-black/10 overflow-hidden relative group transition-all duration-500 hover:shadow-primary/10 ${onClick ? 'cursor-pointer hover:scale-[1.02] active:scale-[0.98]' : ''} ${variantClasses} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: shadow-primary
   `className={`m3-info-card p-6 md:p-10 shadow-xl md:shadow-2xl backdrop-blur-2xl border border-white/10 dark:border-black/10 overflow-hidden relative group transition-all duration-500 hover:shadow-primary/10 ${onClick ? 'cursor-pointer hover:scale-[1.02] active:scale-[0.98]' : ''} ${variantClasses} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: shadow-inner
   `<div className="p-5 rounded-2xl bg-white/30 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-inner border border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">`
...
🟡 **WARNING:** Legacy CSS class detected: justify-center
   `<div className="p-5 rounded-2xl bg-white/30 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-inner border border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">`
🟡 **WARNING:** Legacy CSS class detected: justify-end
   `{action && <div className="mt-8 flex justify-end">{action}</div>}`
🟡 **WARNING:** Legacy CSS class detected: items-start
   `<div className="flex flex-col md:flex-row gap-8 items-start relative z-10">`
🟡 **WARNING:** Legacy CSS class detected: items-center
   `<div className="p-5 rounded-2xl bg-white/30 dark:bg-black/20 backdrop-blur-md flex items-center justify-center shadow-inner border border-white/20 group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">`
🟡 **WARNING:** Legacy CSS class detected: rounded-full
...
🟡 **WARNING:** Legacy CSS class detected: p-8
   `<div className={`p-8 bg-surface-container-low/50 border border-outline-variant/10 flex items-center justify-between group/item hover:bg-surface-container-low transition-colors rounded-2xl ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: justify-between
   `<div className={`p-8 bg-surface-container-low/50 border border-outline-variant/10 flex items-center justify-between group/item hover:bg-surface-container-low transition-colors rounded-2xl ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: items-center
   `<div className={`p-8 bg-surface-container-low/50 border border-outline-variant/10 flex items-center justify-between group/item hover:bg-surface-container-low transition-colors rounded-2xl ${className}`}>`
🟡 **WARNING:** Legacy CSS class detected: rounded-2xl
...
🟡 **WARNING:** Legacy CSS class detected: text-base
   `lg: { container: 'text-4xl', badge: 'text-base px-2.5 py-1' }`
...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: border-box
...
🟡 **WARNING:** Legacy CSS class detected: shadow-elevation
   `elevated: 'bg-surface-container-low shadow-elevation-1 border-white/10',`
🟡 **WARNING:** Legacy CSS class detected: shadow-none
   `outlined: 'bg-surface border-outline/30 shadow-none',`
🟡 **WARNING:** Legacy CSS class detected: shadow-elevation
   `filled: 'bg-surface-container-high shadow-elevation-1 border-white/5'`
🟡 **WARNING:** Legacy CSS class detected: shadow-elevation
...
🟡 **WARNING:** Legacy CSS class detected: border-b
   `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-outline-variant/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-surface-container-highest/10 to-transparent">`
🟡 **WARNING:** Legacy CSS class detected: border-outline
   `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-outline-variant/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-surface-container-highest/10 to-transparent">`
🟡 **WARNING:** Legacy CSS class detected: border-t
   `<div className="px-4 md:px-6 py-4 border-t border-outline-variant/10 bg-surface-container-low/50 flex justify-end items-center gap-6 shrink-0">`
🟡 **WARNING:** Legacy CSS class detected: border-outline
   `<div className="px-4 md:px-6 py-4 border-t border-outline-variant/10 bg-surface-container-low/50 flex justify-end items-center gap-6 shrink-0">`
🟡 **WARNING:** Legacy CSS class detected: shadow-2xl
...
🟡 **WARNING:** Legacy CSS class detected: px-6
   `<div className="px-4 md:px-6 py-4 border-t border-outline-variant/10 bg-surface-container-low/50 flex justify-end items-center gap-6 shrink-0">`
🟡 **WARNING:** Legacy CSS class detected: py-4
   `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-outline-variant/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-surface-container-highest/10 to-transparent">`
🟡 **WARNING:** Legacy CSS class detected: py-6
   `<div className="px-4 md:px-6 py-4 md:py-6 border-b border-outline-variant/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-transparent via-surface-container-highest/10 to-transparent">`
🟡 **WARNING:** Legacy CSS class detected: py-4
   `<div className="px-4 md:px-6 py-4 border-t border-outline-variant/10 bg-surface-container-low/50 flex justify-end items-center gap-6 shrink-0">`
🟡 **WARNING:** Legacy CSS class detected: py-4
   `<p className="m3-body-large text-on-surface py-4">{message}</p>`
🟡 **WARNING:** Legacy CSS class detected: mx-4
   `mx-4`
...
🟡 **WARNING:** Legacy CSS class detected: rounded-full
   `className="w-10 h-10 rounded-full hover:bg-surface-container-highest flex items-center justify-center transition-colors ml-4"`
🟡 **WARNING:** Legacy CSS class detected: glass-blur
   `style={{ backdropFilter: `blur(var(--sys-glass-blur))` }}`
🟡 **WARNING:** Legacy CSS class detected: sys-glass
   `style={{ backdropFilter: `blur(var(--sys-glass-blur))` }}`
🔵 **INFO:** Consider using M3Typography for text: "close"
   `<span className="material-symbols-outlined">close</span>`
🔵 **INFO:** Consider using M3Typography for text: ";
...
🟡 **WARNING:** Legacy CSS class detected: shadow-xl
   `className={`p-8 md:p-12 transition-all duration-300 flex flex-col min-h-[160px] md:min-h-[180px] ${isClickable ? 'cursor-pointer hover:shadow-xl hover:shadow-black/10 hover:border-white/30 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2' : ''} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: shadow-black
   `className={`p-8 md:p-12 transition-all duration-300 flex flex-col min-h-[160px] md:min-h-[180px] ${isClickable ? 'cursor-pointer hover:shadow-xl hover:shadow-black/10 hover:border-white/30 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2' : ''} ${className}`}`
🟡 **WARNING:** Legacy CSS class detected: shadow-lg
   `<div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-white/25 to-white/10 backdrop-blur-md flex items-center justify-center shadow-lg border border-white/20 flex-shrink-0">`
🟡 **WARNING:** Legacy CSS class detected: p-8
...
🟡 **WARNING:** Legacy CSS class detected: my-1
   `<div className="m3-menu__divider border-outline-variant my-1" role="separator"></div>`
🟡 **WARNING:** Legacy CSS class detected: flex-1
...
**Issues:**
🟡 **WARNING:** Legacy CSS class detected: bg-scrim
...
🟡 **WARNING:** Legacy CSS class detected: border-radius
   `border-radius: var(--md-sys-shape-corner-small);`
🟡 **WARNING:** Legacy CSS class detected: shadow-elevation1
   `className={`m3-popover fixed bg-surface border-outline-variant rounded shadow-elevation1 ${className || ''}`.trim()}`
🟡 **WARNING:** Legacy CSS class detected: p-4
   `<div className="m3-popover__header p-4 border-outline-variant">`
🟡 **WARNING:** Legacy CSS class detected: p-4
...
🔵 **INFO:** Consider using M3Typography for text: "*"
   `* >`
🔵 **INFO:** Consider using M3Typography for text: "Edit"
...
🟡 **WARNING:** Legacy CSS class detected: border-l
...
🟡 **WARNING:** Legacy CSS class detected: bg-outline
   `className="w-10 h-10 rounded-full flex items-center justify-center bg-outline-variant/20 group-open:rotate-180"`
🟡 **WARNING:** Legacy CSS class detected: text-2xl
   `<span className="material-symbols-outlined text-2xl">{icon}</span>`
🟡 **WARNING:** Legacy CSS class detected: border-none
   `className="m3-expansion-panel group border-none bg-surface-container-low/50 backdrop-blur-sm rounded-2xl mb-8 overflow-hidden"`
🟡 **WARNING:** Legacy CSS class detected: shadow-sm
   `className="p-6 rounded-2xl bg-surface-container-highest shadow-sm group-hover:scale-110"`
🟡 **WARNING:** Legacy CSS class detected: p-6
   `className="p-6 rounded-2xl bg-surface-container-highest shadow-sm group-hover:scale-110"`
🟡 **WARNING:** Legacy CSS class detected: px-6
...
🟡 **WARNING:** Legacy CSS class detected: text-primary
   `<div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary">`
🟡 **WARNING:** Legacy CSS class detected: text-xl
...
🟡 **WARNING:** Legacy CSS class detected: text-error
...
🟡 **WARNING:** Legacy CSS class detected: text-sm
   `<div className="mt-8 flex gap-8 p-8 bg-secondary-container/30 rounded-xl text-sm border border-secondary/10">`
🟡 **WARNING:** Legacy CSS class detected: text-secondary
...
🟡 **WARNING:** Legacy CSS class detected: shadow-sm
   `<div className="bg-surface/80 backdrop-blur-md p-6 rounded-3xl border border-outline-variant/30 shadow-sm hover:shadow-md transition-shadow">`
🟡 **WARNING:** Legacy CSS class detected: shadow-md
   `<div className="bg-surface/80 backdrop-blur-md p-6 rounded-3xl border border-outline-variant/30 shadow-sm hover:shadow-md transition-shadow">`
🟡 **WARNING:** Legacy CSS class detected: p-6
   `<div className="bg-surface/80 backdrop-blur-md p-6 rounded-3xl border border-outline-variant/30 shadow-sm hover:shadow-md transition-shadow">`
🟡 **WARNING:** Legacy CSS class detected: p-8
