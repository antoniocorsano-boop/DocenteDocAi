        ...
        >
            <M3DialogContent style={{ backgroundColor: "var(--md-sys-color-surface-container-high)", opacity: 0.3, gap: "var(--md-sys-spacing-4)" }}>
                ...
                <div style={{display: "flex", flexDirection: "column", gap: "var(--md-sys-spacing-6)"}}>
                    <button onClick={handleSimpleShare} style={{ borderRadius: "var(--md-sys-shape-corner-large)", backgroundColor: "var(--md-sys-color-surface-container-lowest)", display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-8)", padding: "var(--md-sys-spacing-8)", transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", textAlign: "left", border: "1px solid var(--md-sys-color-outline)" }}>
                        <div style={{ borderRadius: "var(--md-sys-shape-corner-large)", color: "var(--md-sys-color-on-secondary-container)", width: "var(--md-sys-spacing-4)", height: "var(--md-sys-spacing-4)", backgroundColor: "var(--md-sys-color-secondary-container)", display: "flex", alignItems: "center", justifyContent: "center", transition: "transform 300ms" }}>
                    ...
                    <button onClick={handleCopyFormatted} style={{ borderRadius: "var(--md-sys-shape-corner-large)", backgroundColor: "var(--md-sys-color-surface-container-lowest)", display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-8)", padding: "var(--md-sys-spacing-8)", transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", textAlign: "left", border: "1px solid var(--md-sys-color-outline)" }}>
                        <div style={{ borderRadius: "var(--md-sys-shape-corner-large)", color: "var(--md-sys-color-on-tertiary-container)", width: "var(--md-sys-spacing-4)", height: "var(--md-sys-spacing-4)", backgroundColor: "var(--md-sys-color-tertiary-container)", display: "flex", alignItems: "center", justifyContent: "center", transition: "transform 300ms" }}>
