...
const VideoAnalysisModal: React.FC<VideoAnalysisModalProps> = ({ onClose }) => {
  const [hasApiKey, setHasApiKey] = useState<boolean | null>(null);
    ...
    const renderContent = () => {
        ...
        if (!hasApiKey) {
            return (
                <div style={{ padding: 'var(--md-sys-spacing-4)', backgroundColor: 'var(--md-sys-color-surface-container-low)', borderRadius: 'var(--md-sys-shape-corner-large)', display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", border: "var(--md-sys-border-width-normal) solid var(--md-sys-color-outline)", marginLeft: 'var(auto)', marginRight: 'var(auto)' }}>
                        ...
                        {isLoading ? (
                            <div style={{ textAlign: "center" }}>
                                <div style={{ marginBottom: 'var(--md-sys-spacing-8)' }}>
                                    <div style={{ width: 'var(--md-sys-spacing-12)', height: 'var(--md-sys-spacing-12)', borderRadius: 'var(--md-sys-shape-corner-small)', marginLeft: 'var(auto)', marginRight: 'var(auto)' }}></div>
                                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
