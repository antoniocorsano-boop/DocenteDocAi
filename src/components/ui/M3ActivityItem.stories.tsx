  ...
  args: {
    children: (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-4)" }}>
        <div style={{ backgroundColor: 'var(--md-sys-spacing-4)' ,  width: "var(--md-sys-spacing-10)", height: "var(--md-sys-spacing-10)", borderRadius: 'var(--md-sys-spacing-4)', display: "flex", alignItems: "center", justifyContent: "center" }}>
          <span style={{ color:  'var(--md-sys-spacing-4)' ,  fontWeight: "500" }}>A</span>
        </div>
        <div style={{ flex: "1" }}>
          <M3Typography variant="body-large" as="p" >
            Activity completed
          </M3Typography>
          <M3Typography variant="body-small" as="p" style={{ color: 'var(--md-sys-spacing-4)' }}>
            2 hours ago
          </M3Typography>
        </div>
        <div style={{ color: 'var(--md-sys-spacing-4)' }}>
  ...
  args: {
    children: (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-4)" }}>
        ...
        <M3Typography variant="label-small" as="span" style={{ color: 'var(--md-sys-spacing-4)' }}>
          New
        </M3Typography>
      </div>
    ),
    ...
    children: (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-4)" }}>
        <img
          ...
          alt="User avatar"
          style={{ width: "var(--md-sys-spacing-10)", height: "var(--md-sys-spacing-10)", borderRadius: 'var(--md-sys-spacing-4)' }}
        />
        <div style={{ flex: "1" }}>
          <M3Typography variant="body-large" as="p" >
        ...
        <div style={{ display: "flex", gap: "var(--md-sys-spacing-2)" }}>
          <button style={{ color: 'var(--md-sys-spacing-4)' ,  border: "var(--md-sys-border-width-thin) solid var(--md-sys-color-outline)", borderRadius: 'var(--md-sys-spacing-4)', fontSize: "var(--md-sys-typescale-body-medium-font-size)" }}>
            View Profile
          </button>
        </div>
      </div>
