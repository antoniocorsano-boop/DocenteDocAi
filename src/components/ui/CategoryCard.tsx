...
const CategoryCard: React.FC<CategoryCardProps> = ({ 
    ...
    <div
        ...
        className={`flex flex-col items-center gap-4 p-5 rounded-2xl border-2 transition-all cursor-pointer group ${isSelected ? 'border-primary bg-primary-container shadow-xl scale-[1.02]' : 'border-outline-variant/20 bg-surface-container/30 hover:border-outline-variant/60 hover:bg-surface-container/50'}`}
    >
        <div
