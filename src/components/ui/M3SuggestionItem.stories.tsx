    ...
    children: (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-3)" }}>
          <div style={{ backgroundColor: 'var(--md-sys-spacing-4)' ,  width: 'var(--md-sys-spacing-4)', height: 'var(--md-sys-spacing-4)', borderRadius: 'var(--md-sys-spacing-4)', display: "flex", alignItems: "center", justifyContent: "center" }}>
        ...
        <button style={{ color: 'var(--md-sys-spacing-4)' ,  border: "var(--md-sys-border-width-normal) solid var(--md-sys-color-outline)", borderRadius: 'var(--md-sys-spacing-4)', fontSize: "var(--md-sys-typescale-body-large-font-size)", transition: `color var(--md-sys-motion-duration-medium)` }}>
          Apply
        </button>
      </div>
    ),
        ...
        {suggestions.map((suggestion, index) => (
          ...
          >
            <div style={{ display: "flex", alignItems: "flex-start", gap: "var(--md-sys-spacing-3)" }}>
              <div style={{ backgroundColor: 'var(--md-sys-spacing-4)' ,  width: "var(--md-sys-spacing-6)", height: "var(--md-sys-spacing-6)", borderRadius: 'var(--md-sys-spacing-4)', display: "flex", alignItems: "center", justifyContent: "center", flexShrink: "0" }}>
                <span style={{ color:  'var(--md-sys-spacing-4)' ,  fontSize: "var(--md-sys-typescale-body-small-font-size)", fontWeight: "500" }}>
                  {index + 1}
                </span>
              </div>
              <M3Typography variant="body-medium" as="p">
  ...
  args: {
    children: (
      <div style={{ display: "flex", alignItems: "center", gap: "var(--md-sys-spacing-3)" }}>
        ...
        <M3Typography variant="body-medium" as="p" style={{ color: 'var(--md-sys-spacing-4)' }}>
