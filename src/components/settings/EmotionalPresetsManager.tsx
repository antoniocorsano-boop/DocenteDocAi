    ...
    overrides: {
      sys: {
        colors: {
          ...
          onSecondary: 'var(--app-color-on-secondary)',
    ...
    overrides: {
      sys: {
        colors: {
          ...
          secondary: 'var(--app-color-secondary)',
          onSecondary: 'var(--app-color-on-secondary)',
          tertiary: 'var(--app-color-primary)',
          onTertiary: 'var(--app-color-on-primary)',
          surface: 'var(--app-color-surface)',
          onSurface: 'var(--app-color-on-surface)',
          background: 'var(--md-sys-color-background)',
          onBackground: 'var(--md-sys-color-on-background)',
        ...
        return (
          <M3Card
            ...
            style={{
              padding: spacing['4'],
              cursor: 'pointer',
              border: isSelected ? `var(--app-border-thick) solid ${layers.sys.color.primary}` : 'none',
