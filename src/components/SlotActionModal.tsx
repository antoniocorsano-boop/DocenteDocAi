    ...
    >
      <M3DialogContent>
            ...
            <div style={{display: "flex", flexDirection: "column", gap: 'var(--md-sys-spacing-6)', marginTop: 'var(--md-sys-spacing-4)'}}>
                ...
                >
                    <div style={{ borderRadius: 'var(--md-sys-shape-corner-large)', color: colors.onPrimaryContainer , width: "var(--md-sys-spacing-12)", height: "var(--md-sys-spacing-12)", backgroundColor: "var(--md-sys-color-primary)", display: "flex", alignItems: "center", justifyContent: "center", transition: "transform var(--md-sys-motion-duration-medium)"}}>
                ...
                >
                    <div style={{ borderRadius: 'var(--md-sys-shape-corner-large)', backgroundColor: 'var(--md-sys-color-surface-container-low)', width: "var(--md-sys-spacing-12)", height: "var(--md-sys-spacing-12)", color: "var(--md-sys-color-secondary)", display: "flex", alignItems: "center", justifyContent: "center", transition: "transform var(--md-sys-motion-duration-medium)" }}>
