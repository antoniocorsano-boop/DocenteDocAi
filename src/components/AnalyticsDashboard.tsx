              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-surface-container rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{formatNumber(analyticsMetrics.totalDocumentsGenerated)}</p>
                      <p className="text-sm text-on-surface-variant">Documenti Generati</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-surface-container rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{formatNumber(analyticsMetrics.aiInteractionsCount)}</p>
                      <p className="text-sm text-on-surface-variant">Interazioni AI</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-surface-container rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{formatNumber(analyticsMetrics.templatesCreated)}</p>
                      <p className="text-sm text-on-surface-variant">Template Creati</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-surface-container rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-2xl font-bold">{formatNumber(analyticsMetrics.exportBatchesCount)}</p>
                      <p className="text-sm text-on-surface-variant">Export Multipli</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-surface-container rounded-xl p-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      <span className="text-sm">Eventi Totali</span>
                      <span className="font-medium">{stats.weeklyActivity}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm">Documenti Generati</span>
                ...
                <div className="bg-surface-container rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    {stats.topFeatures.length > 0 ? stats.topFeatures.map(([feature, count]) => (
                      ...
                      <p className="text-sm text-on-surface-variant">Nessuna attività registrata</p>
                    )}
                  </div>
                </div>
              </div>
                ...
                {analyticsEvents.slice(-20).reverse().map(event => (
                  <div key={event.id} className="bg-surface-container rounded-lg p-3">
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="font-medium text-sm">{event.featureName}</p>
