                ...
                {timelineItems.map((item, index) => {
                    ...
                    return (
                        <div key={item.id} >
                            ...
                            <div 
                                style={{ backgroundColor: 'var(--md-sys-color-surface-container-high)'/40 , padding: 'var(--md-sys-spacing-5)', border: "1px solid var(--md-sys-color-outline)", transition: "all 300ms cubic-bezier(0.4, 0, 0.2, 1)", cursor: "pointer"}} 
