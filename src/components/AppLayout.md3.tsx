      ...
      >
          ...
          <>
            ...
            <nav
              ...
              style={{
                ...
                borderRadius: '0 var(--md-sys-radius-6) var(--md-sys-radius-6) 0',
                overflow: 'hidden',
              }}
            >
              <div
              ...
              >
                <span
                  style={{
                    fontFamily: 'var(--md-sys-typescale-title-large-font-family, var(--font-family))',
                    fontSize: 'var(--md-sys-typescale-title-large-font-size, var(--md-sys-spacing-5))',
                    fontWeight: '600',
                ...
                >
                  <span className="material-symbols-outlined" aria-hidden="true" style={{ fontSize: 'var(--md-sys-spacing-6)' }}>close</span>
                </button>
              </div>
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        transition: 'background-color var(--md-sys-motion-duration-short) var(--md-sys-motion-easing-emphasized)',
                      }}
                    >
                      <span
                      ...
                      <span
                        style={{
                          ...
                          fontSize: 'var(--md-sys-typescale-label-large-font-size, var(--md-sys-spacing-4))',
              ...
              >
                <button
                  ...
                  style={{
                    ...
                    border: 'none',
                    cursor: 'pointer',
                    background: view === 'settings' ? 'var(--md-sys-color-secondary-container)' : 'transparent',
                    color: view === 'settings' ? 'var(--md-sys-color-on-secondary-container)' : 'var(--md-sys-color-on-surface-variant)',
                  }}
                >
                  <span className="material-symbols-outlined" aria-hidden="true" style={{ fontSize: 'var(--md-sys-spacing-6)' }}>settings</span>
                  <span style={{ fontFamily: 'var(--font-family)', fontSize: 'var(--md-sys-typescale-label-large-font-size, var(--md-sys-spacing-4))' }}>Impostazioni</span>
                </button>
              </div>
            </nav>
          </>
        ...
        <main
          ...
          style={{
            ...
            overflowY: 'auto',
            overflowX: 'hidden',
            paddingBottom: showBottomNav ? 'var(--bottom-nav-height, var(--md-sys-spacing-16))' : '0',
          }}
        >
          {children}
        </main>
