            ...
            <div  style={{padding: 'var(--md-sys-spacing-6)', marginLeft: "var(--md-sys-margin-auto)", marginRight: "var(--md-sys-margin-auto)"}}>
                ...
                <div style={{ backgroundColor: 'var(--md-sys-color-surface-container-low)'/30, borderRadius: ref.shape[6], padding: 'var(--md-sys-spacing-4)' , textAlign: "center", border: 'var(--md-sys-border-width-normal) solid var(--md-sys-color-outline)', gap: 'var(--md-sys-spacing-8)'}}>
                    <div style={{marginTop: 'var(--md-sys-spacing-4)'}}>
                        ...
                        <p style={{ color: 'var(--md-sys-color-on-surface-variant)' ,  fontSize: 'var(--md-sys-typescale-title-medium-font-size)', fontWeight: "500", opacity: "0.8", marginLeft: "var(--md-sys-margin-auto)", marginRight: "var(--md-sys-margin-auto)", lineHeight: "1.625" }}>
                    ...
                    >
                        <div style={{display: "flex", alignItems: "center", gap: 'var(--md-sys-spacing-8)'}}>
                            ...
                            <span  style={{ fontSize: 'var(--md-sys-typescale-title-medium-font-size)', transition: "transform var(--md-sys-motion-duration-long)" }}>arrow_forward</span>
                        </div>
                    </M3Button>
                </div>
