            ...
            <div  style={{padding: 'var(--md-sys-spacing-6)', marginLeft: "auto", marginRight: "auto"}}>
                ...
                <div style={{ backgroundColor: 'var(--md-sys-color-surface-container-low)', opacity: 'var(--md-sys-state-opacity-tint-moderate)', borderRadius: 'var(--md-sys-shape-corner-large)', padding: 'var(--md-sys-spacing-8)', textAlign: "center", border: 'var(--md-sys-border-width-normal) solid var(--md-sys-color-outline)', gap: 'var(--md-sys-spacing-8)' }}>
                    ...
                    <div style={{marginTop: 'var(--md-sys-spacing-4)'}}>
                        ...
                        <p style={{ color: 'var(--md-sys-color-on-surface-variant)' ,  fontSize: 'var(--md-sys-typescale-title-large-font-size)', fontWeight: "var(--md-sys-typescale-weight-medium)", opacity: "var(--md-sys-state-opacity-caption)", marginLeft: "auto", marginRight: "auto", lineHeight: "1.625" }}>
