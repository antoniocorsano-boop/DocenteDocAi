        ...
        >
            <M3DialogContent style={{ backgroundColor: 'var(--md-sys-color-surface-container-high)', padding: 'var(--md-sys-spacing-6)', gap: 'var(--md-sys-spacing-6)'}}>
                ...
                <div style={{display: "flex", flexWrap: "wrap", gap: 'var(--md-sys-spacing-2)', marginBottom: 'var(--md-sys-spacing-6)'}}>
                    <span style={{ backgroundColor: 'var(--md-sys-color-primary-container)', borderRadius: 'var(--md-sys-spacing-4)', color: "var(--md-sys-color-primary)", fontSize: "var(--md-sys-typescale-body-small-font-size)", fontWeight: "bold", display: "flex", alignItems: "center", gap: 'var(--md-sys-spacing-1)'}}>
                        <span  style={{ fontSize: "var(--md-sys-typescale-body-medium-font-size)" }}>school</span>
                        Classe {uda.classe}
                    </span>
                    <span style={{ backgroundColor: 'var(--md-sys-color-secondary-container)', borderRadius: 'var(--md-sys-spacing-4)', color: "var(--md-sys-color-on-secondary-container)", fontSize: "var(--md-sys-typescale-body-small-font-size)", fontWeight: "bold", display: "flex", alignItems: "center", gap: 'var(--md-sys-spacing-1)'}}>
                        <span  style={{ fontSize: "var(--md-sys-typescale-body-medium-font-size)" }}>menu_book</span>
                        {uda.materia}
                    </span>
                    <span style={{ backgroundColor: 'var(--md-sys-color-tertiary-container)', borderRadius: 'var(--md-sys-spacing-4)', color: "var(--md-sys-color-on-tertiary-container)", fontSize: "var(--md-sys-typescale-body-small-font-size)", fontWeight: "bold", display: "flex", alignItems: "center", gap: 'var(--md-sys-spacing-1)'}}>
                        <span  style={{ fontSize: "var(--md-sys-typescale-body-medium-font-size)" }}>event</span>
                ...
                <div style={{ backgroundColor: 'var(--md-sys-color-primary-container)', borderRadius: 'var(--md-sys-shape-corner-large)' , border: "var(--md-sys-border-width-normal) solid var(--md-sys-color-outline)", padding: 'var(--md-sys-spacing-4)', gap: 'var(--md-sys-spacing-3)'}}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                        <div style={{display: "flex", alignItems: "center", gap: 'var(--md-sys-spacing-2)'}}>
                            ...
                            <span style={{fontSize: "var(--md-sys-typescale-body-medium-font-size)", fontWeight: "900", color: "var(--md-sys-color-on-surface)", textTransform: "uppercase", letterSpacing: "0.1em"}}>Validazione Curricolo Verticale</span>
                        </div>
                        <M3Button onClick={handleValidate} variant="secondary" disabled={isValidating} style={{ fontSize: "var(--md-sys-typescale-body-small-font-size)", fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.1em" }}>
                    ...
                    {validationResult && (
                        <div style={{ backgroundColor: 'var(--md-sys-color-surface-container-low)', borderRadius: 'var(--md-sys-shape-corner-large)' , padding: 'var(--md-sys-spacing-4)', border: "var(--md-sys-border-width-normal) solid var(--md-sys-color-outline)"}}>
                            <p  style={{fontSize: "var(--md-sys-typescale-body-medium-font-size)", color: "var(--md-sys-color-on-surface)", lineHeight: "1.625"}}>
                                {validationResult}
                            </p>
                        </div>
                    )}
                ...
                {/* Phases Timeline */}
                <div>
                    <h3 style={{ color: 'var(--md-sys-color-on-surface-variant)', fontSize: "var(--md-sys-typescale-body-medium-font-size)", fontWeight: "bold", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: 'var(--md-sys-spacing-2)'}}>Fasi di Lavoro</h3>
                        ...
                        {uda.phases.map((phase) => (
                            <div key={phase.id} >
                                ...
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                                    ...
                                    <span style={{ color: 'var(--md-sys-color-on-secondary-container)', fontSize: "var(--md-sys-typescale-body-small-font-size)", fontWeight: "900", backgroundColor: "var(--md-sys-color-secondary-container)", borderRadius: "var(--md-sys-shape-corner-small)", textTransform: "uppercase"}}>{phase.duration}h</span>
                                </div>
                                <p  style={{fontSize: "var(--md-sys-typescale-body-medium-font-size)", color: "var(--md-sys-color-on-surface)", fontWeight: "500"}}>{phase.description}</p>
                                <p style={{ color: 'var(--md-sys-color-on-surface-variant)',  fontSize: "var(--md-sys-typescale-body-small-font-size)" }}>{phase.activities}</p>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div  style={{display: "grid", gridTemplateColumns: "1fr", gap: 'var(--md-sys-spacing-4)'}}>
                    ...
                    <InfoCard title="Valutazione" icon="fact_check" variant="tonal" style={{padding: 'var(--md-sys-spacing-4)'}}>
                        <p style={{fontSize: "var(--md-sys-typescale-body-medium-font-size)", color: "var(--md-sys-color-on-surface)"}}>{uda.evaluation}</p>
                    </InfoCard>
                </div>
            </M3DialogContent>
