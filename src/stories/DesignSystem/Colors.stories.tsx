...
const ColorDocumentation = () => (
  <div style={{ padding: 'var(--md-sys-spacing-6)', fontFamily: 'var(--md-sys-typescale-body-large-font-family)' }}>
    <h1 style={{ fontSize: 'var(--md-sys-typescale-headline-small-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginBottom: 'var(--md-sys-spacing-4)' }}>Material Design 3 Color System</h1>
    ...
    <h2 style={{ fontSize: 'var(--md-sys-typescale-title-large-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginTop: 'var(--md-sys-spacing-8)', marginBottom: 'var(--md-sys-spacing-4)' }}>Primary Colors</h2>
    ...
    <h2 style={{ fontSize: 'var(--md-sys-typescale-title-large-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginTop: 'var(--md-sys-spacing-8)', marginBottom: 'var(--md-sys-spacing-4)' }}>Secondary Colors</h2>
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(var(--md-sys-layout-workflow-card-min-width), var(--md-sys-grid-fr-1)))', gap: 'var(--md-sys-spacing-4)', marginBottom: 'var(--md-sys-spacing-6)' }}>
...
const ColorSwatch: React.FC<ColorSwatchProps> = ({ name, token, hex, border = false, small = false }) => (
  <div style={{ textAlign: 'center' }}>
    ...
    />
    <strong style={{ fontSize: small ? 'var(--md-sys-typescale-body-small-size)' : 'var(--md-sys-typescale-body-medium-size)' }}>{name}</strong>
    <div style={{ fontSize: small ? 'var(--md-sys-typescale-body-small-size)' : 'var(--md-sys-typescale-body-small-size)', color: 'var(--md-sys-color-on-surface-variant)', marginTop: 'var(--md-sys-spacing-1)' }}>
      <code style={{ fontSize: 'var(--md-sys-typescale-body-small-size)' }}>{token}</code>
      <br />
      {hex}
    </div>
  </div>
