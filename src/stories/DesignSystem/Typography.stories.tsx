...
const TypographyDocumentation = () => (
  <div style={{ padding: 'var(--md-sys-spacing-6)', fontFamily: 'var(--font-family)' }}>
    <h1 style={{ fontSize: layers.ref.spacing['4'], fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', marginBottom: 'var(--md-sys-spacing-4)' }}>Typography System</h1>
    ...
    <div style={{ marginBottom: 'var(--md-sys-spacing-8)', padding: 'var(--md-sys-spacing-4)', backgroundColor: 'var(--md-sys-color-surfaceContainer)', borderRadius: 'var(--md-sys-spacing-2)' }}>
      ...
      <p style={{ fontSize: 'var(--md-sys-typescale-body-medium-font-size)', lineHeight: layers.ref.spacing['4'], marginBottom: 'var(--md-sys-spacing-2)' }}>
        <strong>Primary Font:</strong> Roboto Flex
      </p>
      <p style={{ fontSize: 'var(--md-sys-typescale-body-medium-font-size)', lineHeight: layers.ref.spacing['4'], marginBottom: 'var(--md-sys-spacing-2)' }}>
        <strong>Monospace Font:</strong> Roboto Mono
      </p>
      <p style={{ fontSize: 'var(--md-sys-typescale-body-medium-font-size)', lineHeight: layers.ref.spacing['4'] }}>
        <strong>Variable Font Range:</strong> Weight 100-1000, Optical Size 8-144
      </p>
    </div>

    <h2 style={{ fontSize: layers.ref.spacing['4'], fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', marginTop: layers.ref.spacing['4'], marginBottom: layers.ref.spacing['4'] }}>Display Styles</h2>
    ...
    <h2 style={{ fontSize: layers.ref.spacing['4'], fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', marginTop: layers.ref.spacing['4'], marginBottom: layers.ref.spacing['4'] }}>Title Styles</h2>
    <p style={{ fontSize: 'var(--md-sys-typescale-body-medium-font-size)', lineHeight: layers.ref.spacing['4'], marginBottom: 'var(--md-sys-spacing-4)', color: sys.colors['666666'] }}>
    ...
    <h2 style={{ fontSize: layers.ref.spacing['4'], fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', marginTop: layers.ref.spacing['4'], marginBottom: layers.ref.spacing['4'] }}>Body Styles</h2>
    <p style={{ fontSize: 'var(--md-sys-typescale-body-medium-font-size)', lineHeight: layers.ref.spacing['4'], marginBottom: 'var(--md-sys-spacing-4)', color: sys.colors['666'] }}>
    ...
    <div style={{ marginBottom: layers.ref.spacing['4'], padding: 'var(--md-sys-spacing-3)', backgroundColor: 'var(--md-sys-color-surfaceContainerLowest)', borderRadius: 'var(--md-sys-spacing-2)' }}>
      ...
      <p style={{ margin: '0', fontSize: 'var(--md-sys-typescale-body-medium-font-size)', lineHeight: 'var(--md-sys-spacing-6)', letterSpacing: 'var(--md-sys-typescale-label-large-tracking)', color: sys.colors['333'] }}>
    ...
    <h2 style={{ fontSize: layers.ref.spacing['4'], fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', marginTop: layers.ref.spacing['4'], marginBottom: layers.ref.spacing['4'] }}>Label Styles</h2>
    <p style={{ fontSize: 'var(--md-sys-typescale-body-medium-font-size)', lineHeight: layers.ref.spacing['4'], marginBottom: 'var(--md-sys-spacing-4)', color: sys.colors['666'] }}>
    ...
    <h2 style={{ fontSize: layers.ref.spacing['4'], fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', marginTop: layers.ref.spacing['4'], marginBottom: layers.ref.spacing['4'] }}>Usage Guidelines</h2>
    <ul style={{ fontSize: 'var(--md-sys-typescale-body-medium-font-size)', lineHeight: 'var(--md-sys-spacing-6)', color: sys.colors['333'], paddingLeft: layers.ref.spacing['4'] }}>
...
const TypeSample: React.FC<TypeSampleProps> = ({
  ...
  <div style={{ marginBottom: compact ? 'var(--md-sys-spacing-6)' : 'var(--md-sys-spacing-8)', padding: compact ? 'var(--md-sys-spacing-3)' : layers.ref.spacing['4'], backgroundColor: bgColor, borderRadius: 'var(--md-sys-spacing-2)' }}>
