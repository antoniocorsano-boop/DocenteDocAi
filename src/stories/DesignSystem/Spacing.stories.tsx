...
const SpacingDocumentation = () => (
  <div style={{ padding: 'var(--md-sys-spacing-6)', fontFamily: 'var(--font-family)' }}>
    <h1 style={{ fontSize: '36px', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', marginBottom: 'var(--md-sys-spacing-4)' }}>Spacing System</h1>
    ...
    <ol style={{ fontSize: 'var(--md-sys-typescale-body-medium-size)', lineHeight: 'var(--md-sys-spacing-6)', color: '#333', paddingLeft: '20px' }}>
    ...
    <div style={{ display: 'flex', alignItems: 'flex-start', gap: 'var(--md-sys-spacing-2)', marginBottom: 'var(--md-sys-spacing-2)' }}>
      <div
        style={{
          ...
          height: value === '0px' ? '2px' : 'var(--md-sys-spacing-8)',
          borderRadius: 'var(--md-sys-spacing-1)',
          flexShrink: 0,
        }}
      />
