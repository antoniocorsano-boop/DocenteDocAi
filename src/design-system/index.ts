...
export const baseDesignSystem: Readonly<DesignSystemDefinition> = Object.freeze({
  ...
  typography: {
    displayLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-display-large-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-display-large-line-height)' }, description: 'Style for large, impactful display text.', cssVar: '--typography-display-large' },
    displayMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-display-medium-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-display-medium-line-height)' }, description: 'Style for medium display text.', cssVar: '--typography-display-medium' },
    displaySmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-display-small-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-display-small-line-height)' }, description: 'Style for small display text.', cssVar: '--typography-display-small' },
    headlineLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-headline-large-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-headline-large-line-height)' }, description: 'Style for large headlines.', cssVar: '--typography-headline-large' },
    headlineMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-headline-medium-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-headline-medium-line-height)' }, description: 'Style for medium headlines.', cssVar: '--typography-headline-medium' },
    headlineSmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-body-medium-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-spacing-8)' }, description: 'Style for small headlines.', cssVar: '--typography-headline-small' },
    titleLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-title-large-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-title-large-line-height)' }, description: 'Style for large titles.', cssVar: '--typography-title-large' },
    titleMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-body-medium-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-spacing-6)' }, description: 'Style for medium titles.', cssVar: '--typography-title-medium' },
    titleSmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-title-small-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-title-small-line-height)' }, description: 'Style for small titles.', cssVar: '--typography-title-small' },
    labelLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-label-large-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-label-large-line-height)' }, description: 'Style for large labels, like buttons.', cssVar: '--typography-label-large' },
    labelMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-spacing-3)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-spacing-4)' }, description: 'Style for medium labels.', cssVar: '--typography-label-medium' },
    labelSmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-label-small-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-typescale-label-small-line-height)' }, description: 'Style for small labels.', cssVar: '--typography-label-small' },
    bodyLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-body-medium-font-size)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-spacing-6)' }, description: 'Style for large body text.', cssVar: '--typography-body-large' },
    ...
    bodySmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-spacing-3)', fontWeight: 'var(--md-sys-typescale-body-medium-font-weight)', lineHeight: 'var(--md-sys-spacing-4)' }, description: 'Style for small body text.', cssVar: '--typography-body-small' },
  },
  spacing: {
