...
export const baseDesignSystem: Readonly<DesignSystemDefinition> = Object.freeze({
  ...
  typography: {
    displayLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-display-large-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-display-large-line-height)' }, description: 'Style for large, impactful display text.', cssVar: '--typography-display-large' },
    displayMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-display-medium-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-display-medium-line-height)' }, description: 'Style for medium display text.', cssVar: '--typography-display-medium' },
    displaySmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-display-small-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-display-small-line-height)' }, description: 'Style for small display text.', cssVar: '--typography-display-small' },
    headlineLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-headline-large-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-headline-large-line-height)' }, description: 'Style for large headlines.', cssVar: '--typography-headline-large' },
    headlineMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-headline-medium-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-headline-medium-line-height)' }, description: 'Style for medium headlines.', cssVar: '--typography-headline-medium' },
    headlineSmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-body-medium-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-spacing-8)' }, description: 'Style for small headlines.', cssVar: '--typography-headline-small' },
    titleLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-title-large-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-title-large-line-height)' }, description: 'Style for large titles.', cssVar: '--typography-title-large' },
    titleMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-body-medium-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-spacing-6)' }, description: 'Style for medium titles.', cssVar: '--typography-title-medium' },
    titleSmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-title-small-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-title-small-line-height)' }, description: 'Style for small titles.', cssVar: '--typography-title-small' },
    labelLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-label-large-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-label-large-line-height)' }, description: 'Style for large labels, like buttons.', cssVar: '--typography-label-large' },
    labelMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-spacing-3)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-spacing-4)' }, description: 'Style for medium labels.', cssVar: '--typography-label-medium' },
    labelSmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-label-small-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-label-small-line-height)' }, description: 'Style for small labels.', cssVar: '--typography-label-small' },
    bodyLarge: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-body-medium-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-spacing-6)' }, description: 'Style for large body text.', cssVar: '--typography-body-large' },
    bodyMedium: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-typescale-body-medium-size)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-typescale-body-medium-line-height)' }, description: 'Style for medium body text.', cssVar: '--typography-body-medium' },
    bodySmall: { value: { fontFamily: "'Roboto', sans-serif", fontSize: 'var(--md-sys-spacing-3)', fontWeight: 'var(--md-sys-typescale-body-medium-weight)', lineHeight: 'var(--md-sys-spacing-4)' }, description: 'Style for small body text.', cssVar: '--typography-body-small' },
  },
  spacing: {
...
export const applyTheme = (theme: Theme): void => {
  ...
  if (themeToApply.radiusMultiplier !== undefined) {
    root.style.setProperty('--md-sys-color-radius-multiplier', themeToApply.radiusMultiplier.toString());
  }
  
  const fontScale = themeToApply.fontScale ?? 1;
  root.style.setProperty('--md-sys-color-font-scale', fontScale.toString());
  root.style.setProperty('--nav-rail-width', `${80 * fontScale}px`);

  if (themeToApply.contrastLevel !== undefined) {
    root.style.setProperty('--md-sys-color-contrast-level', themeToApply.contrastLevel.toString());
