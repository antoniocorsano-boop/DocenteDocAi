export const getTechnicalDocumentContentPrompt = () => `
...
export const getAcademicEssayContentPrompt = () => `
...
export const getMarkdownReportPrompt = (type: string, data: Record<string, unknown>) => `
...
export const getDocumentTablePrompt = (description: string) => `
